...
class Network(torch.nn.Module):
    ...
    def forward(self, query, key, value, sparse_indices, scale_value,
                ...
                sparse_mode, pre_tokens, next_tokens, attention_mode, return_softmax_lse, sinks):
        kwargs = {
            "query": query,
            "key": key,
            "value": value,
