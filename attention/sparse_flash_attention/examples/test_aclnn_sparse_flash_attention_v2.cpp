...
int main() {
  ...
  ret = aclnnSparseFlashAttentionV2GetWorkspaceSize(q, k, v, sparseIndices, nullptr, actSeqQLen, actSeqKvLen,
            qRope, kRope, sinks, scaleValue, sparseBlockSize, layoutQuery, layoutKey, sparseMode, preTokens,
            nextTokens, attentionMode, returnSoftmaxLse, out, softmaxMax, softmaxSum, &workspaceSize, &executor);
