...
ASCENDC_TPL_ARGS_DECL(QuantSparseFlashMla, // 算子OpType
                      ...
                      ASCENDC_TPL_BOOL_DECL(IS_VEC_S2PHYADDR, 0, 1), ASCENDC_TPL_BOOL_DECL(BATCH_CONSISTENCY, 0, 1));
...
ASCENDC_TPL_SEL(ASCENDC_TPL_ARGS_SEL(
    ...
    ASCENDC_TPL_BOOL_SEL(SPLIT_G, 0, 1), ASCENDC_TPL_UINT_SEL(KV_DTYPE, ASCENDC_TPL_UI_LIST, DTYPE_HIF8),
    ASCENDC_TPL_BOOL_SEL(IS_VEC_S2PHYADDR, 0, 1), ASCENDC_TPL_BOOL_SEL(BATCH_CONSISTENCY, 0, 1)));
