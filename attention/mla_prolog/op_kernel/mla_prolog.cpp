...
__global__ __aicore__ void mla_prolog(__gm__ uint8_t *tokenX, __gm__ uint8_t *weightDq, __gm__ uint8_t *weightUqQr,
                                      ...
                                      __gm__ uint8_t *dequantScaleWDq, __gm__ uint8_t *dequantScaleWUqQr,
                                      __gm__ uint8_t *dequantScaleWDkvKr, __gm__ uint8_t *quantScaleCkv,
                                      __gm__ uint8_t *quantScaleCkr, __gm__ uint8_t *smoothScalesCq,
                                      __gm__ uint8_t *queryOut, __gm__ uint8_t *queryRopeOut,
                                      __gm__ uint8_t *kvCacheOut, __gm__ uint8_t *krCacheOut, __gm__ uint8_t *workspace,
                                      __gm__ uint8_t *tiling)
{
    ...
    if constexpr (static_cast<SCENARIO>(Scenario) == SCENARIO::NO_QUANT) {
        ...
        op.Init(tokenX, weightDq, weightUqQr, weightUk, weightDkvKr, rmsnormGammaCq, rmsnormGammaCkv, ropeSin, ropeCos,
                ...
                dequantScaleWDkvKr, quantScaleCkv, quantScaleCkr, smoothScalesCq, nullptr, nullptr, queryOut,
                queryRopeOut, nullptr, nullptr, nullptr, workspace);
        op.Process();
