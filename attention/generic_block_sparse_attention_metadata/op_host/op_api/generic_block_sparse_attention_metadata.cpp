    ...
    int64_t isConsistentTopk, const aclTensor *metadata, aclOpExecutor *executor)
{
    ...
    auto ret = ADD_TO_LAUNCHER_LIST_AICPU(
        ...
        OP_ATTR_NAMES({"max_q_seq_len", "num_q_heads", "num_kv_heads", "head_dim", "block_shape_x", "block_shape_y",
                       "is_packed_gqa", "q_input_layout", "aic_core_num", "residual_block_mode", "is_consistent_topk"}),
        ...
        OP_ATTR(maxQSeqLen, numQHeads, numKvHeads, headDim, blockShapeX, blockShapeY, isPackedGQA, qInputLayout,
                aicCoreNum, residualBlockMode, isConsistentTopk));
