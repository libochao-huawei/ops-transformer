...
#ifndef SPARSE_FLASH_MLA_TEMPLATE_TILING_KEY_H
#define SPARSE_FLASH_MLA_TEMPLATE_TILING_KEY_H
...
ASCENDC_TPL_ARGS_DECL(SparseFlashMla, // 算子OpType
                      ...
                      ASCENDC_TPL_UINT_DECL(LAYOUT_T, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, SMLA_LAYOUT_BSND,
                                            SMLA_LAYOUT_TND),
                      ASCENDC_TPL_UINT_DECL(KV_LAYOUT_T, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, SMLA_LAYOUT_PA_BNBD, SMLA_LAYOUT_BSND, SMLA_LAYOUT_TND),
...
ASCENDC_TPL_SEL(
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_BOOL_SEL(FLASH_DECODE, 0),
                         ...
                         ASCENDC_TPL_UINT_SEL(KV_LAYOUT_T, ASCENDC_TPL_UI_LIST, SMLA_LAYOUT_PA_BNBD, SMLA_LAYOUT_BSND, SMLA_LAYOUT_TND),
