...
public:
    ...
    using mmOutputType =
        typename AscendC::Conditional<PFAT::msdMode == MsdMode::MSD_ON, int32_t, mmOutputTypeTmp>::type;
...
protected:
    ...
    __aicore__ inline void PseOrMaskCopyIn(int64_t offset, uint32_t souterSize, bool isInnerTail, uint32_t alignSInner,
                                           uint32_t unalignSInner, uint32_t padSize, bool isMask,
                                           uint32_t souterTailMaskCopyInSize);

    __aicore__ inline void SparseBandElewiseCompute(int32_t ubPingpong, uint32_t souterSize,
    ...
    __aicore__ inline void SInnerLoopFunc(int64_t sInnerFirstToken, int64_t sInnerEndToken, int curBatch,
    ...
    __aicore__ inline void MsdRowSum(LocalTensor<FT> &dstUb, LocalTensor<FT> srcUb, uint32_t dealRowCount,
                                     uint32_t columnCount, uint32_t actualColumnCount);

    __aicore__ inline void MsdRowMax(LocalTensor<FT> &aMaxDstUb, LocalTensor<FT> &srcUb, uint32_t dealRowCount,
                                     uint32_t columnCount, uint32_t actualColumnCount);
    ...
    __aicore__ inline void MsdAntiParamsMulByRow(LocalTensor<FT> &dstUb, LocalTensor<FT> &antiParams,
                                                 LocalTensor<FT> &src1Ub, uint32_t dealRowCount, uint32_t columnCount,
                                                 uint32_t actualColumnCount);

    __aicore__ inline void MsdFusedMulAddByRow(LocalTensor<FT> &dstLocal, LocalTensor<FT> &src0Local,
                                               LocalTensor<FT> &src1Local, uint32_t dealRowCount, uint32_t columnCount,
                                               uint32_t actualColumnCount);

    __aicore__ inline void MsdMulMaxAddSumByRow(LocalTensor<FT> &dstLocal, LocalTensor<FT> &src0RowMax,
                                                LocalTensor<FT> &src1RowSum, uint32_t dealRowCount,
                                                uint32_t columnCount, uint32_t actualColumnCount);

    __aicore__ inline void MsdVecMulMat(LocalTensor<FT> &dstUb, LocalTensor<FT> &src0Ub, LocalTensor<FT> &src1Ub,
                                        uint32_t dealRowCount, uint32_t columnCount, uint32_t actualColumnCount);

    __aicore__ inline void Bmm1MsdCopyQueryGm2Ub(LocalTensor<FT> &queryUb, int64_t queryOffset, uint32_t dealRowCount,
                                                 uint32_t columnCount, uint32_t actualColumnCount);
    ...
    __aicore__ inline void MsdMatmulPreProcess(PFAComputeParam *params, GlobalTensor<KV_T> dstGm,
                                               LocalTensor<FT> &msdMaxResUb, LocalTensor<FT> &srcUb,
                                               LocalTensor<FT> &tmpAFloorUb, uint32_t startRow, uint32_t dealRowCount,
                                               uint32_t columnCount, uint32_t actualColumnCount, int gmPingpong);

    __aicore__ inline void Bmm1MsdCalcQueryRowSum(LocalTensor<FT> &queryUb, uint32_t startRow, uint32_t dealRowCount,
                                                  uint32_t columnCount, uint32_t actualColumnCount, int gmPingpong);
    ...
    __aicore__ inline void MsdMatmulResCombine(LocalTensor<FT> &bmmResUb, GlobalTensor<mmOutputType> srcGm,
                                               uint32_t expandLineCnt, uint32_t startRow, uint32_t dealRowCount,
                                               uint32_t columnCount, uint32_t actualColumnCount, int gmPingpong);

    __aicore__ inline void MsdCopyAntiquantParamsPerToken(GlobalTensor<FT> srcGm, int64_t offset, uint32_t columnCount,
                                                          uint32_t actualColumnCount);
    ...
    __aicore__ inline void Bmm1MsdSqueezeResMulScaleKPerToken(PFAComputeParam *params, LocalTensor<FT> &mmResUb,
                                                              uint32_t dealRowCount, uint32_t columnCount,
                                                              uint32_t actualColumnCount, int gmPingpong);

    __aicore__ inline void Bmm1MsdSqueezePerToken(PFAComputeParam *params, LocalTensor<FT> &bmm1ResUb,
                                                  uint32_t startRow, uint32_t dealRowCount, int gmPingpong);

    __aicore__ inline void Bmm1MsdSqueeze(PFAComputeParam *params, LocalTensor<FT> &bmm1ResUb, uint32_t startRow,
                                          uint32_t dealRowCount, int ubPingpong, int gmPingpong);

    __aicore__ inline void Bmm2MsdExpandMm1ResMulScaleVPerToken(PFAComputeParam *params, LocalTensor<FT> &mmResUb,
                                                                uint32_t dealRowCount, uint32_t columnCount,
                                                                uint32_t actualColumnCount, int gmPingpong);

    __aicore__ inline void Bmm2MsdExpandResPerToken(PFAComputeParam *params, LocalTensor<FT> &mmResUb,
                                                    GlobalTensor<KV_T> bmm1ExpandGm, uint32_t startRow,
                                                    uint32_t dealRowCount, uint32_t columnCount,
                                                    uint32_t actualColumnCount, int gmPingpong);
    ...
    __aicore__ inline void Bmm2MsdExpandPertoken(PFAComputeParam *params, LocalTensor<FT> &mmResUb,
                                                 GlobalTensor<KV_T> bmm1ExpandGm, uint32_t startRow,
                                                 uint32_t dealRowCount, int gmPingpong);

    __aicore__ inline void Bmm2MsdExpand(PFAComputeParam *params, LocalTensor<FT> &mmResUb,
                                         GlobalTensor<KV_T> bmm1ExpandGm, uint32_t startRow, uint32_t dealRowCount,
                                         int gmPingpong);

    __aicore__ inline void Bmm2MsdSqueezeResMulMax(LocalTensor<FT> &bmm2ResUb, uint32_t startRow, uint32_t dealRowCount,
                                                   uint32_t columnCount, uint32_t actualColumnCount, int gmPingpong);

    __aicore__ inline void Bmm2MsdSqueezePertoken(PFAComputeParam *params, LocalTensor<FT> &bmm2ResUb,
                                                  GlobalTensor<mmOutputType> bmm2ResGmDb, int gmPingpong);

    __aicore__ inline void Bmm2MsdSqueeze(PFAComputeParam *params, LocalTensor<computeType> &bmm2ResUb,
                                          GlobalTensor<mmOutputType> bmm2ResGmDb, int gmPingpong);

    __aicore__ inline void CopyAntiquantScale(LocalTensor<FT> &castUb, GlobalTensor<T> srcGm, int64_t offset);

    __aicore__ inline void VecAddMat(LocalTensor<FT> dstUb, LocalTensor<FT> src0Ub, LocalTensor<FT> src1Ub,
                                     uint32_t dealRowCount, uint32_t columnCount, uint32_t actualColumnCount);

    __aicore__ inline void MsdSoftmaxResPreProcess(PFAComputeParam *params, GlobalTensor<KV_T> dstGm,
                                                   LocalTensor<FT> srcUb, LocalTensor<FT> tmpAFloorUb,
                                                   uint32_t startRow, uint32_t dealRowCount, uint32_t columnCount,
                                                   uint32_t actualColumnCount, int gmPingpong);

    __aicore__ inline void Bmm1MsdExpandPerchannel(PFAComputeParam *params);

    __aicore__ inline void Bmm1MsdSqueezePerchannel(PFAComputeParam *params, LocalTensor<FT> &bmm1ResUb,
                                                    uint32_t startRow, uint32_t dealRowCount, int gmPingpong);

    __aicore__ inline void Bmm2MsdExpandPerchannel(PFAComputeParam *params, LocalTensor<FT> &bmm1ResUb,
                                                   GlobalTensor<KV_T> &bmm1ExpandGm, uint32_t startRow,
                                                   uint32_t dealRowCount, int gmPingpong);

    __aicore__ inline void Bmm2MsdSqueezePerchannel(PFAComputeParam *params, LocalTensor<FT> &bmm2ResUb,
                                                    GlobalTensor<mmOutputType> &srcGM, int gmPingpong);
    ...
    __aicore__ inline void Bmm2Antiquant(PFAComputeParam *params)
    {
        ...
        if (this->tilingData->promptAttentionBaseParams.isAntiPerchannel &&
            PFAT::MM_TYPE != MatMulType::MM_PA_ANTIQUANT) {
            scaleLocal.SetSize(headSize);
            offsetLocal.SetSize(headSize);
            DataCopy(scaleLocal,
                     this->antiquantScaleGm[((int64_t)this->tilingData->promptAttentionBaseParams.headNumSize +
                                             (int64_t)params->batchNOffset) /
                                            this->headNumRatio * headSize],
                     headSize);
            if (!this->isAntiquantSymmetric) {
                DataCopy(offsetLocal,
                         this->antiquantOffsetGm[((int64_t)this->tilingData->promptAttentionBaseParams.headNumSize +
                                                  (int64_t)params->batchNOffset) /
                                                 this->headNumRatio * headSize],
                         headSize);
            } else {
        ...
        if (this->tilingData->promptAttentionBaseParams.isAntiPerchannel &&
            ...
            scaleLocal.SetSize(headSize);
            offsetLocal.SetSize(headSize);
            DataCopy(scaleLocal, this->valueAntiquantScaleGm[params->batchNOffset / this->headNumRatio * headSize],
                     headSize);
            if (this->msdIsVOffsetExist) {
                DataCopy(offsetLocal,
                         this->valueAntiquantOffsetGm[params->batchNOffset / this->headNumRatio * headSize], headSize);
            } else {
                Duplicate(offsetLocal, static_cast<T>(0), headSize); // Symmetric quantization
            }
        }
        ...
        for (int loopIdx = 0; loopIdx < kvAntiquantLoopTimes; loopIdx++) {
            int64_t kvComputeSInnerSize =
                (loopIdx == kvAntiquantLoopTimes - 1) ? (params->singleProcessSInnerBmmTail - loopIdx * step) : step;
            ...
            if (PFAT::MM_TYPE != MatMulType::MM_PA_ANTIQUANT) {
                ...
                if constexpr (PFAT::enablePrefix) {
                    ...
                    if (this->isKvContinuous == 0) {
                        ...
                        __gm__ uint8_t *tempValueGm =
                            (__gm__ uint8_t *)valueListDesc.GetDataPtr<__gm__ uint8_t>(params->taskBatch);
                        this->valueGm.SetGlobalBuffer((__gm__ KV_T *)tempValueGm);
                    }
                    DataCopy(srcLocal, this->valueGm[vOffset], kvCopyParam);
                }
            } else {
                uint32_t kvHeadNum = this->tilingData->promptAttentionBaseParams.headNumSize /
                                     this->tilingData->promptAttentionBaseParams.headNumRatio;
                ...
                while (i < kvComputeSInnerSize) {
                    ...
                    kvCopyParam.blockCount =
                        remainBlockNum > kvComputeSInnerSize - i ? kvComputeSInnerSize - i : remainBlockNum;
                    uint64_t curOffset = 0;
                    uint32_t blockId = *(reinterpret_cast<__gm__ int32_t *>(this->blocktable_ptr) +
                                         params->taskBatch * blockTableDim2 + blockTableIdx);
                    if (this->tilingData->promptAttentionBaseParams.PAlayoutType == 1) {
                        curOffset = blockId * blockSize * kvHeadNum * headSize + offsetInBlock * kvHeadNum * headSize +
                                    nOffset * headSize;
                    } else {
                        curOffset = blockId * blockSize * kvHeadNum * headSize + nOffset * blockSize * headSize +
                                    offsetInBlock * headSize;
                    }
            ...
            AntiQuantShapeInfo antiquantShape = {
            ...
            if (this->tilingData->promptAttentionBaseParams.isAntiPerchannel) {
                AscendAntiQuant<KV_T, T, false>(dstLocal, srcLocal, offsetLocal, scaleLocal, kvComputeSInnerSize,
                                                antiquantShape);
            } else {
                AscendAntiQuant<KV_T, T, false>(dstLocal, srcLocal, this->valueAntiquantOffset,
                                                this->valueAntiquantScale, kvComputeSInnerSize, antiquantShape);
            }
            this->kvAntiquantDstQueue.EnQue(dstLocal);

            dstLocal = this->kvAntiquantDstQueue.template DeQue<T>();
            DataCopy(this->valueGmAntiquant[static_cast<int64_t>(loopIdx) * step * headSize], dstLocal,
                     kvComputeSInnerSize * headSize);
    ...
    __aicore__ inline void Bmm1Antiquant(PFAComputeParam *params)
    {
        ...
        if (this->tilingData->promptAttentionBaseParams.isAntiPerchannel &&
            ...
            scaleLocal.SetSize(headSize);
            offsetLocal.SetSize(headSize);
            DataCopy(scaleLocal, this->antiquantScaleGm[params->batchNOffset / this->headNumRatio * headSize],
                     headSize);
            if (!this->isAntiquantSymmetric) {
                DataCopy(offsetLocal, this->antiquantOffsetGm[params->batchNOffset / this->headNumRatio * headSize],
                         headSize);
            } else {
                Duplicate(offsetLocal, static_cast<T>(0), headSize); // Symmetric quantization
            }
        ...
        if (this->tilingData->promptAttentionBaseParams.isAntiPerchannel &&
            ...
            scaleLocal.SetSize(headSize);
            offsetLocal.SetSize(headSize);
            DataCopy(scaleLocal, this->keyAntiquantScaleGm[params->batchNOffset / this->headNumRatio * headSize],
                     headSize);
            if (this->msdIsKOffsetExist) {
                DataCopy(offsetLocal, this->keyAntiquantOffsetGm[params->batchNOffset / this->headNumRatio * headSize],
                         headSize);
            } else {
                Duplicate(offsetLocal, static_cast<T>(0), headSize); // Symmetric quantization
            }
        ...
        for (int loopIdx = 0; loopIdx < kvAntiquantLoopTimes; loopIdx++) {
            Bmm1AntiquantEachLoop(params, scaleLocal, offsetLocal, kvCopyParam, step, kvAntiquantLoopTimes, headSize,
                                  loopIdx);
        }
        event_t bmmWaitAntiEvt = static_cast<event_t>(GetTPipePtr()->FetchEventID(HardEvent::MTE3_MTE2));
        SetFlag<HardEvent::MTE3_MTE2>(bmmWaitAntiEvt);
    ...
    __aicore__ inline void Bmm1AntiquantEachLoop(PFAComputeParam *params, LocalTensor<T> scaleLocal,
                                                 LocalTensor<T> offsetLocal, DataCopyParams kvCopyParam, int step,
                                                 int kvAntiquantLoopTimes, int headSize, int loopIdx)
    {
        int64_t kvComputeSInnerSize =
            (loopIdx == kvAntiquantLoopTimes - 1) ? (params->singleProcessSInnerBmmTail - loopIdx * step) : step;
        kvComputeSInnerSize = kvComputeSInnerSize > step ? step : kvComputeSInnerSize;
        ...
        if (PFAT::MM_TYPE != MatMulType::MM_PA_ANTIQUANT) {
            ...
            if constexpr (PFAT::enablePrefix) {
                ...
                if (this->isKvContinuous == 0) {
                    ...
                    __gm__ uint8_t *tempKeyGm =
                        (__gm__ uint8_t *)keyListDesc.GetDataPtr<__gm__ uint8_t>(params->taskBatch);
        ...
        Bmm1AntiquantEachFlow(params, srcLocal, dstLocal, scaleLocal, offsetLocal, step, kvComputeSInnerSize, headSize,
                              loopIdx);
    }

    __aicore__ inline void Bmm1AntiquantEachFlow(PFAComputeParam *params, LocalTensor<int8_t> srcLocal,
                                                 LocalTensor<T> dstLocal, LocalTensor<T> scaleLocal,
                                                 LocalTensor<T> offsetLocal, int step, int64_t kvComputeSInnerSize,
                                                 int headSize, int loopIdx)
    {
        this->kvAntiquantSrcQueue.EnQue(srcLocal);
        srcLocal = this->kvAntiquantSrcQueue.template DeQue<int8_t>();
        ...
        if (this->tilingData->promptAttentionBaseParams.isAntiPerchannel) {
            ...
            AscendAntiQuant<KV_T, T, false>(dstLocal, srcLocal, this->keyAntiquantOffset, this->keyAntiquantScale,
                                            kvComputeSInnerSize, antiquantShape);
        }
        this->kvAntiquantDstQueue.EnQue(dstLocal);

        dstLocal = this->kvAntiquantDstQueue.template DeQue<T>();
        DataCopy(this->keyGmAntiquant[static_cast<int64_t>(loopIdx) * step * headSize], dstLocal,
                 kvComputeSInnerSize * headSize);
    ...
    __aicore__ inline void Bmm1ComputeIterate(PFAComputeParam *params)
    {
        if (this->mm1SingleCoreNPrev != params->mm1SingleCoreN) {
            ...
            this->mm.SetOrgShape(this->tilingData->bmm1TilingDataRect.M * this->msdIterNum,
                                 this->tilingData->bmm1TilingDataRect.N, this->tilingData->bmm1TilingDataRect.Ka,
                                 this->tilingData->bmm1TilingDataRect.Kb, params->mm1SingleCoreN);
        ...
        if constexpr (PFAT::msdMode != MsdMode::MSD_ON and
    ...
    __aicore__ inline void Bmm1GmResCopyInUb(LocalTensor<computeType> &mmResUb, int64_t gmOffset, int32_t blockCount,
                                             int32_t blockLen, int32_t srcStride, int pingpong, int ubPingpong,
                                             uint32_t souterSize, bool unalign, uint32_t alignSInner,
                                             uint32_t unalignSInner, bool setCopyIn)
    {
        if (unalign) {
    ...
    __aicore__ inline void SoftmaxResCopyOut(LocalTensor<computeType> &mmResUb, int64_t gmOffset, int pingpong,
                                             int ubPingpong, uint32_t singleProcessSInnerSizeNow)
    {
        if constexpr (PFAT::calcMode == OptimizationMode::HighPrecision || IsSameType<T, bfloat16_t>::value) {
            ...
            this->mm1GmUbCopyParam[ubPingpong].blockLen =
                singleProcessSInnerSizeNow / (32 / sizeof(T)); // 32 : 32B alignment
        }

        this->Bmm1Queue.EnQue(
            mmResUb); // Can't move forward. It must be placed here, otherwise there will be an accuracy error.
        ...
        if constexpr (PFAT::calcMode == OptimizationMode::HighPrecision || IsSameType<T, bfloat16_t>::value) {
            ...
            tmpBmm1ResGmDb.SetGlobalBuffer(
                reinterpret_cast<__gm__ T *>(this->bmm1ResGmDb[pingpong][gmOffset / 2].address_), mmResUb.GetSize());
            LocalTensor<T> tmpSoftmaxResUb = mmResUb.template ReinterpretCast<T>();
            ...
            if constexpr (PFAT::MM_TYPE == MatMulType::MM_IBSHARE_NORM &&
                          PFAT::calcMode == OptimizationMode::HighPerformance) {
                PFAComputeParam *params = this->headParams;
                if (params->isLastInnerIter &&
                    params->singleProcessSInnerBmmTail <= SINGLE_PROCESS_SINNER_BMMTAIL_LIMIT) {
                    this->mm1GmUbCopyParam[ubPingpong].dstStride =
                        (params->mm2SingleKAlign - params->mm1SingleCoreN) * sizeof(T) / MM2_SINGLE_K_ALIGN_SIZE;
                }
            }
    ...
    __aicore__ inline void Res1VecCompute(PFAComputeParam *params)
    {
        ...
        uint32_t padSize = 0;
        for (int64_t souterOffset = 0; souterOffset < params->singleProcessSOuterSize;
             souterOffset = nextSouterOffset) { // Pending rectification
            int64_t leftSouterSize = params->singleProcessSOuterSize - souterOffset;
            int64_t souterSize =
                (leftSouterSize >= this->softmaxSouterStepLen) ? this->softmaxSouterStepLen : leftSouterSize;
            ...
            bool noLastLastSoftmaxLoop =
                (nextSouterOffset + this->softmaxSouterStepLen < params->singleProcessSOuterSize);
            int64_t nextLeftSouterSize = params->singleProcessSOuterSize - nextSouterOffset;
            int64_t nextSouterSize =
            ...
            // mm1 + mask*-10000
            softmaxMaxUbSub =
                this->softmaxMaxUb_[souterOffset * 8]; // 8 softmaxShapeArray, The length of the second dimension
            softmaxSumUbSub =
                this->softmaxSumUb_[souterOffset * 8]; // 8 softmaxShapeArray, The length of the second dimension
            ...
            if (params->usePseShift) {
                ...
                if constexpr (AscendC::IsSameType<pseShiftCastType, float>::value) {
                    LocalTensor<float> pseShiftCastTensor =
                        this->pseShiftCastBuff_.template Get<float>(this->pseShiftUbSize);
                ...
                if (params->useMask &&
                    params->sparseBandSelect0) { // mask pre fetch. In non band OptimizationMode, the sparseBandSelect0
                                                 // is true. Just focus on the previous useMask.
                    if constexpr (PFAT::enablePrefix) {
                        padSize = params->isPrefixInnerIter ? params->padPrefixSize : params->padSize;
                    } else {
                        padSize = params->padSize;
                    }
                    this->PseOrMaskCopyIn(attenMaskOffset, souterSize, params->isInnerTail, params->maskCopyInCol,
            ...
            if (this->attentionMaskType == 4) { // 4:band OptimizationMode of sparseMode
                ...
                this->template ElewiseCompute<U>(this->mmResUb[ubPingpong], souterSize,
                                                 params->singleProcessSInnerSizeNow, params->maskCopyInCol,
                                                 params->useMask, this->bmm1ResCopyInEvent[ubPingpong], 0);
            }

            this->isSoftmaxResNeedUpdate = (params->isFirstInnerIter || this->softmaxSouterStepLen == 0 ||
            ...
            if (params->isFirstInnerIter) {
                if ((params->singleProcessSInnerBmmTail % basicSoftmaxSinner == 0) &&
                    (params->singleProcessSInnerBmmTail <= basicSoftmaxK) && (souterSize % basicSoftmaxSouter == 0)) {
                    this->SoftmaxBasicComputeFirstNoTail(this->mmResUb[ubPingpong], softmaxMaxUbSub, softmaxSumUbSub,
                                                         souterSize);
                } else {
                    this->SoftmaxComputeFirstTail(this->mmResUb[ubPingpong], softmaxMaxUbSub, softmaxSumUbSub,
                                                  souterSize);
                }
            } else {
                ...
                if ((params->singleProcessSInnerBmmTail % basicSoftmaxSinner == 0) &&
                    (params->singleProcessSInnerBmmTail <= basicSoftmaxK) && (souterSize % basicSoftmaxSouter == 0)) {
                    this->SoftmaxBasicComputeNoTail(this->mmResUb[ubPingpong], softmaxMaxUbSub, softmaxSumUbSub,
                                                    softmaxExpUbSub, souterSize);
                } else {
                    this->SoftmaxComputeTail(this->mmResUb[ubPingpong], softmaxMaxUbSub, softmaxSumUbSub,
                                             softmaxExpUbSub, souterSize);
                }
                PipeBarrier<PIPE_V>();
            }
            ...
            if (noLastSoftmaxLoop) {
                ...
                if (params->usePseShift) { // pse pre fetch
                    ...
                    this->PseOrMaskCopyIn(pseShiftOffset, nextSouterSize, params->isInnerTail,
                                          ...
                                          nextSouterSize);
                } else if (params->useMask &&
                           params
                               ->sparseBandSelect0) { // mask pre fetch. In non band OptimizationMode, the
                                                      // sparseBandSelect0 is true. Just focus on the previous useMask.
                    if constexpr (PFAT::enablePrefix) {
                        padSize = params->isPrefixInnerIter ? params->padPrefixSize : params->padSize;
                    } else {
                        padSize = params->padSize;
                ...
                if constexpr (PFAT::msdMode == MsdMode::MSD_ON) {
                    Bmm1MsdSqueeze(params, this->mmResUb[ubPingpong ^ 1], nextSouterOffset, nextSouterSize,
                                   ubPingpong ^ 1, params->gmPingpong);
                } else {
                    this->Bmm1GmResCopyInUb(
                        this->mmResUb[ubPingpong ^ 1], nextMm1ResGmOffset, nextSouterSize,
                        params->singleProcessSInnerSizeNow / this->softmaxTypeByteNum,
            ...
            if constexpr (IsSameType<T, int8_t>::value) {
                ...
                this->QuantCompute(softmaxQuantResUb, this->mmResUb[ubPingpong], this->quantScale1, 0,
                                   souterSize * params->singleProcessSInnerSizeNow);
                // Synchronize vector quant calculation before copying, while modifying copy parameters to int8
                // attribute.
                ...
                this->mm1GmUbCopyParam[ubPingpong].dstStride =
                    (params->mm1SingleCoreN - params->singleProcessSInnerSizeNow) / this->typeByteNum;
                this->mm1GmUbCopyParam[ubPingpong].srcStride = 0;
                DataCopy(this->quant1ResGmDb[params->gmPingpong][mm1ResGmOffset], softmaxQuantResUb,
                         this->mm1GmUbCopyParam[ubPingpong]);
                SetFlag<HardEvent::MTE3_MTE2>(this->bmm1ResCopyOutEvent[ubPingpong]);
            } else if constexpr (!IsSameType<T, KV_T>::value && IsSameType<KV_T, int8_t>::value and
                                 PFAT::msdMode == MsdMode::MSD_ON) {
                Bmm2MsdExpand(params, this->mmResUb[ubPingpong], this->bmm1ExpandGm[params->gmPingpong], souterOffset,
                              souterSize, params->gmPingpong);
            } else {
                // softmax res copyOut
                this->SoftmaxResCopyOut(this->mmResUb[ubPingpong], mm1ResGmOffset, params->gmPingpong, ubPingpong,
    ...
    __aicore__ inline void Bmm2ComputeIterate(const uint32_t BIdx, const uint32_t NIdx,
                                              const uint32_t sInnerOffsetDataSize)
    {
        PFAComputeParam *params = this->headParams;

        uint32_t mm2KaStride = params->mm1SingleCoreN;
        if constexpr (PFAT::MM_TYPE == MatMulType::MM_IBSHARE_NORM &&
                      (IsSameType<T, half>::value && PFAT::calcMode == OptimizationMode::HighPerformance)) {
            mm2KaStride =
                params->isLastInnerIter && params->singleProcessSInnerBmmTail <= SINGLE_PROCESS_SINNER_BMMTAIL_LIMIT ?
        ...
        if constexpr (IsSameType<T, int8_t>::value) {
        ...
        } else if constexpr (PFAT::msdMode != MsdMode::MSD_ON and
                             (PFAT::calcMode == OptimizationMode::HighPrecision || IsSameType<T, bfloat16_t>::value)) {
            ...
            GlobalTensor<T> tmpBmm1ResGmDb;
            tmpBmm1ResGmDb.SetGlobalBuffer(reinterpret_cast<__gm__ T *>(this->bmm1ResGmDb[params->gmPingpong].address_),
                                           gmSize);
    ...
    __aicore__ inline LocalTensor<computeType> AllocBmm2UbRes(PFAComputeParam *params, bool useTbuf,
...
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::PseOrMaskCopyIn(int64_t offset, uint32_t souterSize,
                                                                               bool isInnerTail, uint32_t alignSInner,
                                                                               uint32_t unalignSInner, uint32_t padSize,
                                                                               bool isMask,
                                                                               uint32_t souterTailMaskCopyInSize)
{
    // Optimize for small Q_S using the actual required Q_S.
        ...
        if (isInnerTail) {
            ...
            if constexpr (IsSameType<T, int8_t>::value) {
                if (((intriParams.blockLen / lenOfType + padSize) % 32) != 0) {
                    intriParams.dstStride = 1; // If qkv is int8，the length of the pad differs by one block and needs
                                               // to be skipped for storage.
                }
            }
        } else {
            padParams.rightPadding = 0;
...
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::Bmm1VecInputCopyIn()
{
    ...
    if (this->softmaxFlashTilingData.srcK != params->singleProcessSInnerSizeNow) {
        uint32_t minSoftmaxSouterStepLen =
            this->softmaxFlashTilingData.srcSize / params->singleProcessSInnerSizeNow / 8 * 8; // 8 alignment
        if (params->useMask) { // When D<=64，maskubsize maybe greater than bmm2ubsize，It will only be divided into 16k
                               // by maskubsize. When mask padding size > sinner padding size，will lead to unauthorized
                               // access.
        ...
        this->softmaxSouterStepLen =
            ((this->softmaxSouterStepLen > params->singleProcessSOuterSize) || (this->softmaxSouterStepLen == 0)) ?
                params->singleProcessSOuterSize :
                this->softmaxSouterStepLen;
    }
    ...
    if constexpr (PFAT::msdMode == MsdMode::MSD_ON) {
        if (this->tilingData->promptAttentionBaseParams.headSize > 256) { // 256:big d for msd OptimizationMode
            ...
            this->softmaxSouterStepLen =
                this->softmaxSouterStepLen > msdComputeLinesTiling ? msdComputeLinesTiling : this->softmaxSouterStepLen;
        } else {
            uint32_t maxSouterSizeTmp =
                this->tilingData->promptAttentionTensorSizeRect.mmResUbSize / params->singleProcessSInnerSizeNow;
            this->softmaxSouterStepLen =
                this->softmaxSouterStepLen > maxSouterSizeTmp ? maxSouterSizeTmp : this->softmaxSouterStepLen;
        }
    ...
    } else if (params->useMask && params->sparseBandSelect0) { // In non band OptimizationMode, sparseBandSelect0 is
                                                               // true. Just focus on what's ahead useMask.
        if constexpr (PFAT::enablePrefix) {
            padSize = params->isPrefixInnerIter ? params->padPrefixSize : params->padSize;
        } else {
            padSize = params->padSize;
    ...
    if constexpr (PFAT::msdMode == MsdMode::MSD_ON) {
        ...
        this->Bmm1GmResCopyInUb(
            this->mmResUb[0], 0, souterSize, params->singleProcessSInnerSizeNow / this->softmaxTypeByteNum,
            (params->mm1SingleCoreN - params->singleProcessSInnerSizeNow) / this->softmaxTypeByteNum,
...
template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::SparseBandElewiseCompute(int32_t ubPingpong,
                                                                                        uint32_t souterSize,
                                                                                        int64_t attenMaskOffsetPre)
{
    PFAComputeParam *params = this->headParams;
    if (params->sparseBandSelect0) { // Select 0 part
        this->template ElewiseCompute<U>(this->mmResUb[ubPingpong], souterSize, params->singleProcessSInnerSizeNow,
                                         params->maskCopyInCol, params->useMask, this->bmm1ResCopyInEvent[ubPingpong],
                                         0);
    }
                                                                         ...
                                                                         uint32_t actualColumnCount)
{
    ...
    for (uint32_t loopCount = blockCount / 2; loopCount > 0; loopCount = blockCount / 2) {
        ...
        for (uint32_t j = 0; j < loopCount; j++) {
            Add(srcUb[j * dtype_mask], srcUb[j * dtype_mask], srcUb[(j + blockCount) * dtype_mask], dtype_mask,
                dealRowCount, repeatParamsMax);
        }
        PipeBarrier<PIPE_V>();
    }

    WholeReduceSum(dstUb, srcUb, (actualColumnCount < dtype_mask) ? actualColumnCount : dtype_mask, dealRowCount, 1, 1,
                   columnCount / (BYTE_BLOCK_PFA / sizeof(FT)));
}

template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::MsdRowMax(LocalTensor<FT> &aMaxDstUb,
                                                                         LocalTensor<FT> &srcUb, uint32_t dealRowCount,
                                                                         ...
                                                                         uint32_t actualColumnCount)
{
    ...
    for (uint32_t loopCount = blockCount / 2; loopCount > 0; loopCount = blockCount / 2) {
        blockCount = (blockCount + 1) / 2;
        for (uint32_t j = 0; j < loopCount; j++) {
            Max(srcUb[j * dtype_mask], srcUb[j * dtype_mask], srcUb[(j + blockCount) * dtype_mask], dtype_mask,
                dealRowCount, repeatParamsMax);
        }
        PipeBarrier<PIPE_V>();
    }
...
template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::MsdAbsRowMax(LocalTensor<FT> &tmpAMaxRes,
                                                                            LocalTensor<FT> &srcUb,
                                                                            LocalTensor<FT> tmpAUb,
                                                                            uint32_t dealRowCount, uint32_t columnCount,
                                                                            uint32_t actualColumnCount)
{
...
template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::MsdRowMuls(LocalTensor<FT> &dstUb,
                                                                          LocalTensor<FT> &src0Ub,
                                                                          LocalTensor<FT> &src1Ub,
                                                                          uint32_t dealRowCount, uint32_t columnCount,
                                                                          uint32_t actualColumnCount)
{
    uint32_t dtype_mask = this->MSD_REPEAT_ELEMENT_NUM;
    ...
    for (uint32_t i = 0; i < dealRowCount; i++) {
        Mul(dstUb[i * columnCount], src0Ub[i * columnCount], src1Ub[i * this->MSD_BLOCK_ELEMENT_NUM], dtype_mask, dLoop,
            columnRepeatParams);
        if (dRemain > 0) {
            Mul(dstUb[dLoop * dtype_mask + i * columnCount], src0Ub[dLoop * dtype_mask + i * columnCount],
                src1Ub[i * this->MSD_BLOCK_ELEMENT_NUM], dRemain, 1, columnRepeatParams);
        }
    }
#else
    ...
    if (columnRepeatCount <= dealRowCount) {
        ...
        columnRepeatParams.dstRepStride = 8;
        for (uint32_t i = 0; i < dealRowCount; i++) {
            Mul(dstUb[i * columnCount], src0Ub[i * columnCount], src1Ub[i * this->MSD_BLOCK_ELEMENT_NUM], dtype_mask,
...
template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::MsdAntiParamsMulByRow(
    LocalTensor<FT> &dstUb, LocalTensor<FT> &antiParams, LocalTensor<FT> &src1Ub, uint32_t dealRowCount,
    uint32_t columnCount, uint32_t actualColumnCount)
{
    uint32_t dtype_mask = this->MSD_REPEAT_ELEMENT_NUM;
    uint32_t dLoop = actualColumnCount / dtype_mask;
    ...
    columnRepeatParams.dstRepStride = 8;
    for (uint32_t i = 0; i < dealRowCount; i++) {
        Mul(dstUb[i * columnCount], antiParams, src1Ub[i * this->MSD_BLOCK_ELEMENT_NUM], dtype_mask, dLoop,
            columnRepeatParams);
        if (dRemain > 0) {
            Mul(dstUb[dLoop * dtype_mask + i * columnCount], antiParams[dLoop * dtype_mask],
                src1Ub[i * this->MSD_BLOCK_ELEMENT_NUM], dRemain, 1, columnRepeatParams);
        }
    }
#else
    ...
    for (int i = 0; i < dLoop; i++) {
        Mul(dstUb[i * dtype_mask], src1Ub, antiParams[i * dtype_mask], dtype_mask, dealRowCount, columnRepeatParams);
    }
    if (dRemain > 0) {
        Mul(dstUb[dLoop * dtype_mask], src1Ub, antiParams[dLoop * dtype_mask], dRemain, dealRowCount,
            columnRepeatParams);
    }
#endif
}
...
template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::MsdFusedMulAddByRow(
    LocalTensor<FT> &dstLocal, LocalTensor<FT> &src0Local, LocalTensor<FT> &src1Local, uint32_t dealRowCount,
    uint32_t columnCount, uint32_t actualColumnCount)
{
    uint32_t dtype_mask = this->MSD_REPEAT_ELEMENT_NUM;
    uint32_t dLoop = actualColumnCount / dtype_mask;
    ...
    for (uint32_t i = 0; i < dealRowCount; i++) {
        FusedMulAdd(dstLocal[i * columnCount], src0Local[i * this->MSD_BLOCK_ELEMENT_NUM], src1Local[i * columnCount],
                    dtype_mask, dLoop, columnRepeatParams);
        if (dRemain > 0) {
            FusedMulAdd(dstLocal[dLoop * dtype_mask + i * columnCount], src0Local[i * this->MSD_BLOCK_ELEMENT_NUM],
                        src1Local[dLoop * dtype_mask + i * columnCount], dRemain, 1, columnRepeatParams);
        }
    }
#else
    columnRepeatParams.src0RepStride = 1;
    ...
    for (int j = 0; j < dLoop; j++) {
        FusedMulAdd(dstLocal[j * dtype_mask], src0Local, src1Local[j * dtype_mask], dtype_mask, dealRowCount,
                    columnRepeatParams);
    }
    if (dRemain > 0) {
        FusedMulAdd(dstLocal[dLoop * dtype_mask], src0Local, src1Local[dLoop * dtype_mask], dRemain, dealRowCount,
                    columnRepeatParams);
    }
#endif
}
...
template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::MsdMulMaxAddSumByRow(
    LocalTensor<FT> &dstLocal, LocalTensor<FT> &src0RowMax, LocalTensor<FT> &src1RowSum, uint32_t dealRowCount,
    uint32_t columnCount, uint32_t actualColumnCount)
{
    uint32_t dtype_mask = this->MSD_REPEAT_ELEMENT_NUM;
    uint32_t dLoop = actualColumnCount / dtype_mask;
    ...
    columnRepeatParams.dstRepStride = 8;
    for (uint32_t i = 0; i < dealRowCount; i++) {
        FusedMulAdd(dstLocal[i * columnCount], src0RowMax[i * this->MSD_BLOCK_ELEMENT_NUM],
                    src1RowSum[i * this->MSD_BLOCK_ELEMENT_NUM], dtype_mask, dLoop, columnRepeatParams);
        if (dRemain > 0) {
            FusedMulAdd(dstLocal[dLoop * dtype_mask + i * columnCount], src0RowMax[i * this->MSD_BLOCK_ELEMENT_NUM],
                        src1RowSum[i * this->MSD_BLOCK_ELEMENT_NUM], dRemain, 1, columnRepeatParams);
        }
    }
#else
    columnRepeatParams.src0RepStride = 1;
    ...
    PipeBarrier<PIPE_V>();
    for (int j = 0; j < dLoop; j++) {
        FusedMulAdd(dstLocal[j * dtype_mask], src0RowMax, src1RowSum, dtype_mask, dealRowCount, columnRepeatParams);
    }
    if (dRemain > 0) {
        FusedMulAdd(dstLocal[dLoop * dtype_mask], src0RowMax, src1RowSum, dRemain, dealRowCount, columnRepeatParams);
    }
#endif
}

template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::MsdVecMulMat(LocalTensor<FT> &dstUb,
                                                                            LocalTensor<FT> &src0Ub,
                                                                            LocalTensor<FT> &src1Ub,
                                                                            uint32_t dealRowCount, uint32_t columnCount,
                                                                            uint32_t actualColumnCount)
{
    ...
    columnRepeatParams.dstRepStride = 8;
    for (uint32_t i = 0; i < dealRowCount; i++) {
        Mul(dstUb[i * columnCount], src0Ub, src1Ub[i * columnCount], dtype_mask, dLoop, columnRepeatParams);
        if (dRemain > 0) {
            Mul(dstUb[dLoop * dtype_mask + i * columnCount], src0Ub[dLoop * dtype_mask],
                src1Ub[dLoop * dtype_mask + i * columnCount], dRemain, 1, columnRepeatParams);
        }
    }
#else
    columnRepeatParams.dstBlkStride = 1;
...
template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::Bmm1MsdCopyQueryGm2Ub(LocalTensor<FT> &queryUb,
                                                                                     int64_t queryOffset,
                                                                                     ...
                                                                                     uint32_t actualColumnCount)
{
    ...
    if constexpr (PFAT::layout == PFALayout::BNSD) {
        ...
        copyInParams.srcStride =
            (this->tilingData->promptAttentionBaseParams.headNumSize - 1) * actualColumnCount * sizeof(T); // BSH
    }
...
template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::MsdAIterExpand(GlobalTensor<int8_t> dstGm,
                                                                              LocalTensor<FT> &tmpA1,
                                                                              LocalTensor<FT> &tmpA2, uint32_t calcSize,
                                                                              bool isFirst, int64_t outOffset,
                                                                              int gmPingpong)
{
    if (!isFirst) {
        // sub
...
template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::MsdMatmulPreProcess(
    PFAComputeParam *params, GlobalTensor<KV_T> dstGm, LocalTensor<FT> &msdMaxResUb, LocalTensor<FT> &srcUb,
    LocalTensor<FT> &tmpAFloorUb, uint32_t startRow, uint32_t dealRowCount, uint32_t columnCount,
    uint32_t actualColumnCount, int gmPingpong)
{
...
// Calc ∑𝐴[𝑗]
template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::Bmm1MsdCalcQueryRowSum(
    LocalTensor<FT> &queryUb, uint32_t startRow, uint32_t dealRowCount, uint32_t columnCount,
    uint32_t actualColumnCount, int gmPingpong)
{
...
template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::MsdMatmulResCombine(
    LocalTensor<FT> &bmmResUb, GlobalTensor<mmOutputType> srcGm, uint32_t expandLineCnt, uint32_t startRow,
...
template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::MsdCopyAntiquantParamsPerToken(
    GlobalTensor<FT> srcGm, int64_t offset, uint32_t columnCount, uint32_t actualColumnCount)
{
...
template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::Bmm1MsdSqueezeResMulOffsetKPerToken(
    PFAComputeParam *params, LocalTensor<FT> &mmResUb, uint32_t startRow, uint32_t dealRowCount, uint32_t columnCount,
    uint32_t actualColumnCount, int gmPingpong)
{
    ...
    if (this->msdIsKOffsetExist) {
        MsdCopyAntiquantParamsPerToken(this->keyAntiquantOffsetGmPerToken, params->antiqParamOffsetPerToken,
...
// 𝑚𝑚1𝑅𝑒𝑠=𝑆𝑐𝑎𝑙𝑒𝐾×𝑺
template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::Bmm1MsdSqueezeResMulScaleKPerToken(
    PFAComputeParam *params, LocalTensor<FT> &mmResUb, uint32_t dealRowCount, uint32_t columnCount,
    uint32_t actualColumnCount, int gmPingpong)
{
    MsdCopyAntiquantParamsPerToken(this->keyAntiquantScaleGmPerToken, params->antiqParamOffsetPerToken, columnCount,
                                   actualColumnCount);
...
template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::Bmm1MsdSqueezePerToken(
    PFAComputeParam *params, LocalTensor<FT> &bmm1ResUb, uint32_t startRow, uint32_t dealRowCount, int gmPingpong)
{
    ...
    uint32_t actualColumnCount =
        (params->isInnerTail ?
             ...
             params->singleProcessSInnerSizeNow); // params->unalignSInner; //params->singleProcessSInnerBmmTail;
    ...
    Bmm1MsdSqueezeResMulOffsetKPerToken(params, bmm1ResUb, startRow, dealRowCount, columnCount, actualColumnCount,
                                        gmPingpong);
...
template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::Bmm1MsdSqueeze(PFAComputeParam *params,
                                                                              LocalTensor<FT> &bmm1ResUb,
                                                                              uint32_t startRow, uint32_t dealRowCount,
                                                                              int ubPingpong, int gmPingpong)
{
    if (this->tilingData->promptAttentionBaseParams.keyAntiquantMode == 0) {
...
// 𝐴′=𝐴×𝑆𝑐𝑎𝑙𝑒𝑉
template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::Bmm2MsdExpandMm1ResMulScaleVPerToken(
    PFAComputeParam *params, LocalTensor<FT> &mmResUb, uint32_t dealRowCount, uint32_t columnCount,
    uint32_t actualColumnCount, int gmPingpong)
{
    MsdCopyAntiquantParamsPerToken(this->valueAntiquantScaleGmPerToken, params->antiqParamOffsetPerToken, columnCount,
                                   actualColumnCount);
    LocalTensor<FT> antiqScalePerTokenUb = this->msdInQueue.template DeQue<FT>();
...
template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::Bmm2MsdExpandResPerToken(
    PFAComputeParam *params, LocalTensor<FT> &mmResUb, GlobalTensor<KV_T> bmm1ExpandGm, uint32_t startRow,
    uint32_t dealRowCount, uint32_t columnCount, uint32_t actualColumnCount, int gmPingpong)
{
    ...
    MsdMatmulPreProcess(params, bmm1ExpandGm, this->msdMaxBmm2Ub[gmPingpong], mmResUb, tmpAFloorUb, startRow,
                        dealRowCount, columnCount, actualColumnCount, gmPingpong);
}

// 𝑃=𝐴′×𝑂𝑓𝑓𝑠𝑒𝑡𝑉; ∑P[𝑗]
template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::Bmm2MsdExpandResMulOffsetVPerToken(
    PFAComputeParam *params, LocalTensor<FT> &mmResUb, uint32_t startRow, uint32_t dealRowCount, uint32_t columnCount,
    uint32_t actualColumnCount, int gmPingpong)
{
    if (!this->msdIsVOffsetExist) {
    ...
    // get 𝑂𝑓𝑓𝑠𝑒𝑡𝑉
    MsdCopyAntiquantParamsPerToken(this->valueAntiquantOffsetGmPerToken, params->antiqParamOffsetPerToken, columnCount,
                                   actualColumnCount);
...
template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::Bmm2MsdExpandPertoken(
    PFAComputeParam *params, LocalTensor<FT> &mmResUb, GlobalTensor<KV_T> bmm1ExpandGm, uint32_t startRow,
    uint32_t dealRowCount, int gmPingpong)
{
    uint32_t columnCount = params->singleProcessSInnerSizeNow;
    uint32_t actualColumnCount =
        (params->isInnerTail ? params->singleProcessSInnerBmmTail : params->singleProcessSInnerSizeNow);
    // 1. Calc 𝐴′=𝐴×𝑆𝑐𝑎𝑙𝑒𝑉
    ...
    Bmm2MsdExpandResMulOffsetVPerToken(params, mmResUb, startRow, dealRowCount, columnCount, actualColumnCount,
                                       gmPingpong);

    // 3. Expand 𝐴′
    Bmm2MsdExpandResPerToken(params, mmResUb, bmm1ExpandGm, startRow, dealRowCount, columnCount, actualColumnCount,
                             gmPingpong);
}

template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::Bmm2MsdExpand(PFAComputeParam *params,
                                                                             LocalTensor<FT> &mmResUb,
                                                                             GlobalTensor<KV_T> bmm1ExpandGm,
                                                                             uint32_t startRow, uint32_t dealRowCount,
                                                                             int gmPingpong)
{
    if (this->tilingData->promptAttentionBaseParams.keyAntiquantMode == 0) {
...
template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::Bmm2MsdSqueezeResMulMax(
    LocalTensor<FT> &bmm2ResUb, uint32_t startRow, uint32_t dealRowCount, uint32_t columnCount,
    uint32_t actualColumnCount, int gmPingpong)
{
    int64_t baseOffset = startRow * this->MSD_BLOCK_ELEMENT_NUM;
...
template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::Bmm2MsdSqueezePertoken(
    PFAComputeParam *params, LocalTensor<FT> &bmm2ResUb, GlobalTensor<mmOutputType> bmm2ResGmDb, int gmPingpong)
{
    uint32_t startRow = 0;
    uint32_t dealRowCount = params->actualSeqLengthPerBatch;
    uint32_t columnCount = this->tilingData->promptAttentionBaseParams.alignedHeadSize;
    ...
    // 1. combine 𝑏𝑚𝑚2𝑅𝑒𝑠𝑈𝑏
    MsdMatmulResCombine(bmm2ResUb, bmm2ResGmDb, params->singleProcessSOuterSize, startRow, dealRowCount, columnCount,
                        actualColumnCount, gmPingpong);
...
template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::Bmm2MsdSqueeze(PFAComputeParam *params,
                                                                              LocalTensor<computeType> &bmm2ResUb,
                                                                              GlobalTensor<mmOutputType> bmm2ResGmDb,
                                                                              int gmPingpong)
{
    if (this->tilingData->promptAttentionBaseParams.keyAntiquantMode == 0) {
...
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::CopyAntiquantScale(LocalTensor<FT> &castUb,
                                                                                  GlobalTensor<T> srcGm, int64_t offset)
{
...
template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::VecAddMat(LocalTensor<FT> dstUb, LocalTensor<FT> src0Ub,
                                                                         LocalTensor<FT> src1Ub, uint32_t dealRowCount,
                                                                         uint32_t columnCount,
                                                                         uint32_t actualColumnCount)
{
...
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::MsdSoftmaxResPreProcess(
    PFAComputeParam *params, GlobalTensor<KV_T> dstGm, LocalTensor<FT> srcUb, LocalTensor<FT> tmpAFloorUb,
...
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::Bmm1MsdExpandPerchannel(PFAComputeParam *params)
{
     ...
     * A3 = round(254*254*(127/Amax * A - A1 - A2 / 254))
     */
    MsdMatmulPreProcess(params, this->queryMsdExpandGm, aMaxBmm1Ub, queryCastUb, aFloorUb, startRow, dealRowCount,
                        columnCount, actualColumnCount, params->gmPingpong);
}
...
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::Bmm2MsdExpandPerchannel(
    PFAComputeParam *params, LocalTensor<FT> &bmm1ResUb, GlobalTensor<KV_T> &bmm1ExpandGm, uint32_t startRow,
    uint32_t dealRowCount, int gmPingpong)
{
    LocalTensor<FT> aFloorUb = this->msdTmpMm2Buff.template Get<FT>();
    ...
    MsdSoftmaxResPreProcess(params, bmm1ExpandGm, bmm1ResUb, aFloorUb, startRow, dealRowCount, columnCount,
                            actualColumnCount, gmPingpong);
}
    ...
    PFAComputeParam *params, LocalTensor<FT> &bmm2ResUb, GlobalTensor<mmOutputType> &srcGM, int gmPingpong)
{
    ...
    uint32_t actualColumnCount = columnCount;
    uint32_t dealRowCount = params->actualSeqLengthPerBatch;
    MsdMatmulResCombine(bmm2ResUb, srcGM, params->singleProcessSOuterSize, startRow, dealRowCount, columnCount,
                        actualColumnCount, gmPingpong);
    PipeBarrier<PIPE_V>();
}
...
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::Bmm1ResDoVecBmm2Compute()
{
    ...
    if (params->isFirstInnerIter) {
        ProcessLastSouterLoopFinalRes(); // Process the output of the last task souter loop. All internal calls require
                                         // the use of preHeadParams.
        ...
        if (this->preHeadParams->fakeMsg) {
            ...
            bmm2ResUb = AllocBmm2UbRes(this->headParams, true,
                                       resShapeSize); // The second time doesn't require addition, use Tbuf.
            this->bmm2.WaitIterateAll();
            if constexpr (PFAT::msdMode == MsdMode::MSD_ON) {
                Bmm2MsdSqueeze(params, bmm2ResUb, this->bmm2ResGmDb[this->headParams->gmPingpong ^ 1],
                               this->headParams->gmPingpong ^ 1);
            } else {
                DataCopy(bmm2ResUb, this->bmm2ResGmDb[this->headParams->gmPingpong ^ 1],
                         resShapeSize); // Process the bmm2 result of the last cycle，so it's ^1.
            ...
            this->Bmm2ComputeIterate(
                params->taskBatch, params->batchNOffset,
                params->sInnerOffsetDataSize); // Triggering the current loop bmm2 computing，using headParams.
...
template <typename PFAT>
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::SInnerLoopFunc(int64_t sInnerFirstToken,
                                                                              int64_t sInnerLastToken, int curBatch,
                                                                              int64_t preTokens, int64_t nextTokens)
{
    // params passing on references. When tailParams, params also update accordingly.
    PFAComputeParam *&params =
        this->tailParams; // Configure new tasks, which will be placed at the end of the queue. Use tailParams.
    ...
    if constexpr (PFAT::enablePrefix) {
        if (this->actualKVPrefixLen < sInnerLastToken) {
            endIndex = (this->actualKVPrefixLen + basicSInnerSize - 1) / basicSInnerSize +
                       (sInnerLastToken - this->actualKVPrefixLen + basicSInnerSize - 1) / basicSInnerSize;
        }
    }
    ...
    // Upper Triangle Mask Scene，dynamic last sinnersize. According to the upper triangle mask，calculate the most
    // compact sinnersize of the current last inner iter.（The minimum sinnersize containing all mask 0 values)
    int64_t firstInnerMargin =
        (sInnerFirstToken - startIndex * basicSInnerSize) / softmaxInnerBasicSize * softmaxInnerBasicSize;
    int64_t lastInnerMargin =
        (endIndex * basicSInnerSize - sInnerLastToken) / softmaxInnerBasicSize * softmaxInnerBasicSize;
    if constexpr (PFAT::MM_TYPE == MatMulType::MM_PA) {
        firstInnerMargin = 0; // To ensure that the mm is not transferred across blocks in PA OptimizationMode,
                              // firstInnerMargin must be set to 0.
    }
    ...
    for (int32_t sInnerLoopIdx = startIndex; sInnerLoopIdx < endIndex; sInnerLoopIdx++) {
        ...
        if (unlikely(isS2Load)) {
            ...
            params->isInnerTail = (sInnerLoopIdx == (int32_t)this->maxInnerLoopTimes - 1) ||
                                  (sInnerLoopIdx == (int32_t)this->maxInnerLoopPrefixTimes - 1);
        }
        ...
        params->mm2SingleKAlign =
            (params->mm1SingleCoreN + MM2_SINGLE_K_ALIGN_SIZE - 1) / MM2_SINGLE_K_ALIGN_SIZE * MM2_SINGLE_K_ALIGN_SIZE;
        if (params->isFirstInnerIter) {
            if constexpr (PFAT::enablePrefix) {
                firstInnerMargin = 0;
            }
        ...
        if (this->attentionMaskType == 2 || this->attentionMaskType == 3) {
            params->useMask = ((sInnerFirstToken + params->singleProcessSOuterSize) >
                                   ((int64_t)sInnerLoopIdx * (int64_t)basicSInnerSize) ||
                               (sInnerLastToken - params->singleProcessSOuterSize <
                                ((int64_t)(sInnerLoopIdx + 1) * (int64_t)basicSInnerSize)));
        }
        ...
        } else { // In Non band OptimizationMode，not involved sparseBandSelect0 and sparseBandSelect1. Set all to true
                 // to ensure that it does not affect public processes.
        ...
        if (this->queSize >= this->queSizeLimit) {
            ...
            if ((sInnerLoopIdx - startIndex) < PFA_PARAMS_QUEUE_CAPBABILITY - 1) {
                // Overwrite the old head parameter. The next tail is not assigned a value outside the Inner loop and
                // has no parameters. We need to copy the parameters that will be recorded outside the loop.
            ...
            this->tailId = (this->tailId + 1) % PFA_PARAMS_QUEUE_CAPBABILITY;
            PFAComputeParam *nextTailParams = &this->pfaParamsQueue[this->tailId];
            // Overwrite the old head parameter. The next tail is not assigned a value outside the Inner loop and has no
            // parameters. We need to copy the parameters that will be recorded outside the loop.
            this->CopyParamsAttrOutOfInnerLoop(nextTailParams, this->tailParams);
            nextTailParams->gmPingpong = this->tailParams->gmPingpong ^ 1;
            this->tailParams = nextTailParams;
            this->queSize++;
...
template <typename PFAT>
__aicore__ inline int64_t PromptFlashAttentionS1s2Bns1X910<PFAT>::ClipSInnerToken(int64_t sInnerToken, int64_t minValue,
                                                                                  int64_t maxValue)
{
...
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::ComputeEachCore(uint32_t coreIdx)
{
    ...
    if constexpr (PFAT::enablePrefix) {
        this->actualKVPrefixLen = this->tilingData->promptAttentionBaseParams.isActualSharedPrefixLenNull ?
                                      this->tilingData->promptAttentionBaseParams.prefixSeqInnerSize :
                                      this->actualSharedPrefixLenGm.GetValue(0);
    } else {
    ...
    for (uint32_t loopNIdx = nLoopStart; loopNIdx < nLoopEnd; loopNIdx++) {
        ...
        for (int sIdx = sIdStart; sIdx < tmpSLoopEnd; sIdx++) {
            ...
            for (uint32_t sOuterLoopIdx = outerLoopStart; sOuterLoopIdx < tmpOuterLoopEnd; sOuterLoopIdx++) {
                ...
                if constexpr (PFAT::MM_TYPE == MatMulType::MM_IBSHARE_NORM) { // Processing from the perspective of cube
                                                                              // to enable L1 reuse.
                    int64_t sOuterOffsetByCube = (int64_t)sOuterLoopIdx * (int64_t)sOuterSize;
                    if (unlikely(sOuterLoopIdx == sOuterBlockNum - 1)) {
                        uint32_t singleProcessSOuterSizeTailByCube =
                            (params->actualSeqLengthPerBatch % sOuterSize != 0) ?
                                params->actualSeqLengthPerBatch % sOuterSize :
                                sOuterSize;
                        uint32_t singleProcessSOuterSizeTailV0 =
                            (singleProcessSOuterSizeTailByCube + 1) / 2; // Tail is divided into two vectors.
                        uint32_t singleProcessSOuterSizeTailV1 =
                            singleProcessSOuterSizeTailByCube - singleProcessSOuterSizeTailV0;
                        params->singleProcessSOuterSize =
                            (coreIdx % 2 == 0) ?
                                singleProcessSOuterSizeTailV0 :
                                singleProcessSOuterSizeTailV1; // 2 : Get whether the vector is odd or even.
                        params->sOuterOffset =
                            sOuterOffsetByCube +
                            ((coreIdx % 2 == 0) ?
                                 0 :
                                 (int64_t)singleProcessSOuterSizeTailV0); // 2 : Get whether the vector is odd or even.
                    } else {
                        ...
                        params->sOuterOffset =
                            ...
                            ((coreIdx % 2 == 0) ?
                                 0 :
                                 (int64_t)this
                                     ->singleProcessSOuterSizeWhole); // 2 : Get whether the vector is odd or even.
                    }
                    params->fakeMsg = (params->singleProcessSOuterSize == 0);
                    sInnerFirstToken = ClipSInnerToken(sOuterOffsetByCube - preTokens, 0,
                                                       params->actualSeqLengthKVPerBatch + this->actualKVPrefixLen);
                    sInnerLastToken = ClipSInnerToken(sOuterOffsetByCube + nextTokens + (int64_t)sOuterSize, 0,
                                                      params->actualSeqLengthKVPerBatch + this->actualKVPrefixLen);
                } else {
                    ...
                    if (nextTokens < 0 &&
                        params->sOuterOffset < ((nextTokens * (-1)) / this->singleProcessSOuterSizeWhole *
                                                this->singleProcessSOuterSizeWhole)) {
                        continue;
                    }
                    sInnerFirstToken = ClipSInnerToken(params->sOuterOffset - (int64_t)preTokens, 0,
                                                       params->actualSeqLengthKVPerBatch + this->actualKVPrefixLen);
                    sInnerLastToken =
                        ClipSInnerToken(params->sOuterOffset + (int64_t)nextTokens + params->singleProcessSOuterSize, 0,
                                        params->actualSeqLengthKVPerBatch + this->actualKVPrefixLen);
                }
...
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::ComputeEachCoreBalance(uint32_t coreIdx)
{
    ...
    int64_t actualSeqLengthsIdx = this->isActualLenDimsNull ? this->tilingData->promptAttentionBaseParams.seqSize :
    ...
    if (this->attentionMaskType == 4) {
        ...
        actualSeqLengthsIdx =
            ((int64_t)actualSeqLengthsIdx > (int64_t)this->tilingData->promptAttentionBaseParams.seqInnerSize +
                                                this->actualKVPrefixLen + (int64_t)preTokens) ?
                this->tilingData->promptAttentionBaseParams.seqInnerSize + this->actualKVPrefixLen + preTokens :
                actualSeqLengthsIdx; // This kernel does not transfer aclualseqlenkv. You do not need to change
                                     // seqInnerSize.
    } else {
        actualSeqLengthsIdx =
            (this->attentionMaskType == 0 &&
             (int64_t)actualSeqLengthsIdx > (int64_t)this->tilingData->promptAttentionBaseParams.seqInnerSize +
                                                this->actualKVPrefixLen +
    ...
    for (int64_t tilingIdx = coreIdx; tilingIdx < totalTilingN;
        ...
        if (sOuterLoopIdx == 0) {
            ...
            params->singleProcessSOuterSize = this->singleProcessSOuterSizeWhole;
            params->sOuterOffset =
                this->singleProcessSOuterSizeTail + (sOuterLoopIdx - 1) * this->singleProcessSOuterSizeWhole;
        }
        if (nextTokens < 0 && params->sOuterOffset < ((nextTokens * (-1)) / this->singleProcessSOuterSizeWhole *
                                                      this->singleProcessSOuterSizeWhole)) {
            continue;
        }
        int64_t sInnerFirstToken = ClipSInnerToken(params->sOuterOffset - preTokens, 0,
                                                   params->actualSeqLengthKVPerBatch + this->actualKVPrefixLen);
        int64_t sInnerLastToken = ClipSInnerToken(params->sOuterOffset + nextTokens + params->singleProcessSOuterSize,
                                                  0, params->actualSeqLengthKVPerBatch + this->actualKVPrefixLen);
        if (sInnerLastToken <= sInnerFirstToken) {
            continue;
        }
...
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::InitEachCoreWorkspace(uint32_t coreIdx, int32_t blockNum)
{
    ...
    this->bmm1ResGmDb[0].SetGlobalBuffer(
        (__gm__ mmOutputType *)this
            ->workspaceGm[blockNum * this->spmTmpSize + coreIdx * mm1ResSize * reuseWorkspaceRatio]
            .GetPhyAddr());
    this->bmm1ResGmDb[1].SetGlobalBuffer(
        (__gm__ mmOutputType *)this
            ->workspaceGm[blockNum * this->spmTmpSize + coreIdx * mm1ResSize * reuseWorkspaceRatio + mm1ResSize]
            .GetPhyAddr());
    if constexpr (IsSameType<T, int8_t>::value) {
        this->quant1ResGmDb[0].SetGlobalBuffer(
            (__gm__ int8_t *)this->workspaceGm[blockNum * this->spmTmpSize + coreIdx * mm1ResSize * reuseWorkspaceRatio]
                .GetPhyAddr());
        this->quant1ResGmDb[1].SetGlobalBuffer(
            (__gm__ int8_t *)this
                ->workspaceGm[blockNum * this->spmTmpSize + coreIdx * mm1ResSize * reuseWorkspaceRatio + mm1ResSize]
                .GetPhyAddr());
    }
    ...
    if constexpr (PFAT::msdMode == MsdMode::MSD_ON) {
        this->bmm1ExpandGm[0].SetGlobalBuffer(
            (__gm__ KV_T *)this->workspaceGm[blockNum * this->spmTmpSize + coreIdx * mm1ResSize * reuseWorkspaceRatio]
                .GetPhyAddr());
        this->bmm1ExpandGm[1].SetGlobalBuffer(
            (__gm__ KV_T *)this
                ->workspaceGm[blockNum * this->spmTmpSize + coreIdx * mm1ResSize * reuseWorkspaceRatio + mm1ResSize]
                .GetPhyAddr());
    }
    ...
    this->bmm2ResGmDb[0].SetGlobalBuffer(
        (__gm__ mmOutputType *)this->workspaceGm[buff_offset + coreIdx * mm2ResSize * reuseWorkspaceRatio]
            .GetPhyAddr());
    this->bmm2ResGmDb[1].SetGlobalBuffer(
        (__gm__ mmOutputType *)this->workspaceGm[buff_offset + coreIdx * mm2ResSize * reuseWorkspaceRatio + mm2ResSize]
            .GetPhyAddr());

    buff_offset += blockNum * mm2ResSize * reuseWorkspaceRatio;

    if constexpr (!IsSameType<T, KV_T>::value && IsSameType<KV_T, int8_t>::value &&
                  PFAT::msdMode != MsdMode::MSD_ON) { // The offset is too large. workspace can be optimized. For
                                                      // details, see the IFA.
        ...
        this->keyGmAntiquant.SetGlobalBuffer(
            (__gm__ T *)workspaceGmAntiquant[coreIdx * kvAntiquantSize * reuseWorkspaceRatio].GetPhyAddr());
        this->valueGmAntiquant.SetGlobalBuffer(
            (__gm__ T *)workspaceGmAntiquant[coreIdx * kvAntiquantSize * reuseWorkspaceRatio + kvAntiquantSize]
                .GetPhyAddr());
        buff_offset += blockNum * kvAntiquantSize * reuseWorkspaceRatio;
    }

    // After placing the four structures of the first kernel, place the four structures of the second kernel，When IFA,
    // After placing the first structure of all kernel, place the second one.
    if constexpr (PFAT::MM_TYPE ==
                  MatMulType::MM_PA) {        // If compute type is different，the offset size here is different.
        ...
        this->bmm1CBDataGm[1].SetGlobalBuffer(
            (__gm__ uint32_t *)workspaceGmPA[baseCBDataOffset + paStructSize].GetPhyAddr());
        this->bmm1CBDataPtr[1] = (__gm__ uint32_t *)workspaceGmPA[baseCBDataOffset + paStructSize].GetPhyAddr();

        this->bmm2CBDataGm[0].SetGlobalBuffer(
            (__gm__ uint32_t *)workspaceGmPA[baseCBDataOffset + paStructSize * reuseWorkspaceRatio].GetPhyAddr());
        this->bmm2CBDataPtr[0] =
            (__gm__ uint32_t *)workspaceGmPA[baseCBDataOffset + paStructSize * reuseWorkspaceRatio].GetPhyAddr();
        this->bmm2CBDataGm[1].SetGlobalBuffer(
            (__gm__ uint32_t *)workspaceGmPA[baseCBDataOffset + paStructSize * reuseWorkspaceRatio + paStructSize]
                .GetPhyAddr());
        this->bmm2CBDataPtr[1] =
            (__gm__ uint32_t *)workspaceGmPA[baseCBDataOffset + paStructSize * reuseWorkspaceRatio + paStructSize]
                .GetPhyAddr();
        buff_offset +=
            blockNum * baseCBDataOffset + paStructSize * reuseWorkspaceRatio + paStructSize * reuseWorkspaceRatio;
    }

    if constexpr (PFAT::msdMode == MsdMode::MSD_ON) {
        GlobalTensor<KV_T> workspaceGmMsd;
        workspaceGmMsd.SetGlobalBuffer((__gm__ KV_T *)this->workspaceGm[buff_offset].GetPhyAddr());
        int32_t MsdtructSize =
            msdExpandsize * this->tilingData->promptAttentionBaseParams.seqSize *
            this->tilingData->promptAttentionBaseParams.headSize; //  dcci cacheline 64B 对齐  16 * 4B = 64B
...
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::ComputeEachCoreSplitSeqOneN(uint32_t coreIdx)
{
    ...
    for (int sIdx = 0; sIdx < sNum; sIdx++) {
        ...
        actualSeqLengths =
            (this->attentionMaskType == 0 &&
             (int64_t)actualSeqLengths > (int64_t)this->tilingData->promptAttentionBaseParams.seqInnerSize +
                                             (int64_t)this->tilingData->promptAttentionBaseParams.preTokens) ?
        ...
        for (uint32_t loopNIdx = 0; loopNIdx < headNum; loopNIdx++) {
            ...
            uint32_t sOutPolicyIdx = (coreIdxCube + bnIdx) %
                                     (actualCoreNums / 2); // actualCoreNums is the number of vector kernel. When cube
                                                           // split kernel, need to compute the number of cube kernel.
            ...
            for (uint32_t sOuterLoopIdxByCube = outerLoopStart; sOuterLoopIdxByCube < outerLoopEnd;
                 sOuterLoopIdxByCube++) {
                ...
                if (unlikely(sOuterLoopIdxByCube == sOuterBlockNum - 1)) {
                    uint32_t singleProcessSOuterSizeTailByCube =
                        (params->actualSeqLengthPerBatch % singleProcessSOuterSizeByCube != 0) ?
                            params->actualSeqLengthPerBatch % singleProcessSOuterSizeByCube :
                            singleProcessSOuterSizeByCube;
                    uint32_t singleProcessSOuterSizeTailV0 = (singleProcessSOuterSizeTailByCube + 1) / 2;
                    uint32_t singleProcessSOuterSizeTailV1 =
                        singleProcessSOuterSizeTailByCube - singleProcessSOuterSizeTailV0;
                    params->singleProcessSOuterSize =
                        (coreIdx % 2 == 0) ? singleProcessSOuterSizeTailV0 : singleProcessSOuterSizeTailV1;
                    params->sOuterOffset =
                        sOuterOffsetByCube + ((coreIdx % 2 == 0) ? 0 : (int64_t)singleProcessSOuterSizeTailV0);
                } else {
                    params->singleProcessSOuterSize = this->singleProcessSOuterSizeWhole;
                    params->sOuterOffset =
                        sOuterOffsetByCube + ((coreIdx % 2 == 0) ? 0 : (int64_t)this->singleProcessSOuterSizeWhole);
                }
                params->fakeMsg = (params->singleProcessSOuterSize == 0);
                int64_t sInnerFirstToken = ClipSInnerToken(sOuterOffsetByCube - preTokens, 0,
                                                           params->actualSeqLengthKVPerBatch + this->actualKVPrefixLen);
                int64_t sInnerLastToken =
                    ClipSInnerToken(sOuterOffsetByCube + nextTokens + (int64_t)singleProcessSOuterSizeByCube, 0,
                                    params->actualSeqLengthKVPerBatch + this->actualKVPrefixLen);
                if (sInnerLastToken <= sInnerFirstToken) {
                    continue;
                }
...
__aicore__ inline void PromptFlashAttentionS1s2Bns1X910<PFAT>::ProcessLastSouterLoopFinalRes()
{
    if (this->copyOutPrevIter) {
        ...
        LocalTensor<computeType> bmm2ResUb =
            AllocBmm2UbRes(this->preHeadParams, !this->needAdd, resShapeSize); // When not adding, use Tbuf directly.
        this->bmm2.WaitIterateAll();
        if constexpr (PFAT::msdMode == MsdMode::MSD_ON) {
            Bmm2MsdSqueeze(this->preHeadParams, bmm2ResUb, this->bmm2ResGmDb[this->preHeadParams->gmPingpong],
                           this->preHeadParams->gmPingpong);
        } else {
        ...
        if (this->needAdd) {
            ...
            event_t tmp = static_cast<event_t>(GetTPipePtr()->FetchEventID(
                HardEvent::MTE2_V)); // If set wait is used continuously，can use Fetch. Otherwise, use Alloc.
