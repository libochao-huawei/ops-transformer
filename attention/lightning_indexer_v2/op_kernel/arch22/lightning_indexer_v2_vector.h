...
/*!
 * \file lightning_indexer_v2_vector.h
 * \brief Vector算子工具函数：CopyIn/CopyOut、DoScale、DoReduce、排序(SortAll/MergeSort/MrgBasicBlock/SparseTopK)等
 */
#ifndef LIGHTNING_INDEXER_V2_VECTOR_H
#define LIGHTNING_INDEXER_V2_VECTOR_H
                               ...
                               int64_t groupInner, int64_t s2Inner, int32_t outerGidx)
{
    ...
    AscendC::Brcb(tmpBuff, weightsUb, LIV2Common::CeilDiv(groupInner, static_cast<int64_t>(B32_BLOCK_ALIGN_NUM)),
...
#endif // LIGHTNING_INDEXER_V2_VECTOR_H