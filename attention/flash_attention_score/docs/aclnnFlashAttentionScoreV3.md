...
- **返回值**
  ...
  <tbody>
    ...
    <tr>
      <td>query、key、value、realShiftOptional、dropMaskOptional、paddingMaskOptional、attenMaskOptional、sinkOptional、softmaxMaxOut、softmaxSumOut、attentionOutOut的数据格式不在支持的范围内。</td>
    </tr>
    <tr>
