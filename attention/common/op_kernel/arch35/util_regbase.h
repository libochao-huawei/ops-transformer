...
#define COMMON_RUN_INFO                                                                                                                                         \
    ...
    int64_t s1SizeAcc;          /* 对于非TND场景 = boIdx * pseInfo.s2Size;                                                                                 \
                                   TND场景等于前面boIdx个batch的s1之和（每个batch的s1不同） */                                                 \
    int64_t s2SizeAcc;          /* 对于非TND场景 = boIdx * pseInfo.s2Size;                                                                                 \
                                   TND场景等于前面boIdx个batch的s2之和（每个batch的s2不同）*/                                                  \
