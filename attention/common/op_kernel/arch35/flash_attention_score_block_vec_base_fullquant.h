...
public:
    ...
    static constexpr bool useDn =
        IsDn(((IsSameType<INPUT_T, float>::value) || isFp8), ((isFp8 && s2BaseSize == 256) || isMxfp8FullQuant),
    ...
    ConstInfo<isInfer, hasRope> &constInfo, int32_t subLoop)
{
    ...
    if constexpr (isFp8 && hasAtten) {
        AttenMaskCopyInDn<hasAtten, hasRope, isInfer, isMxfp8FullQuant>(
        ...
        if constexpr (isFp8) {
            if (attenMaskInfoPtr->computeMode != AttenMaskComputeMode::NO_NEED_COMPUTE_MODE) {
                FaVectorApi::ProcessVec1VfDnMxfp8<T, INPUT_T, false, hasAtten, mxfp8s2BaseSize>(
                    ...
                    static_cast<T>(constInfo.scaleValue), descaleQK, constInfo.pScale, negativeFloatScalar,
                    constInfo.keepProb, true, preLoopMaxUb, preLoopSumUb, firstLoopSumUb, subLoop);
            } else {
                FaVectorApi::ProcessVec1VfDnMxfp8<T, INPUT_T, false, false, mxfp8s2BaseSize>(
                    stage1CastTensor, sumUb, maxUb, mmRes, expUb, this->vselrIndexesBuf, attenMaskUb,
                    ((runInfo.s1RealSizeAlign32 >> 1) + 63) >> 6 << 6, runInfo.s2AlignedSize / 2, mxfp8s2RealSize,
                    static_cast<T>(constInfo.scaleValue), descaleQK, constInfo.pScale, negativeFloatScalar,
                    constInfo.keepProb, false, preLoopMaxUb, preLoopSumUb, firstLoopSumUb, subLoop);
            }
        }
    } else {
        if constexpr (isFp8) {
    ...
    if (unlikely(runInfo.s2LoopCount == 0)) {
        if constexpr (isFp8) {
            FaVectorApi::ProcessVec1VfDn<T, INPUT_T, false, hasAtten, s2BaseSize>(
                ...
                runInfo.s2EndIdx - s1BaseSize < s2BaseSize, constInfo.pScale);
        } else {
        ...
        if constexpr (isFp8) {
            FaVectorApi::ProcessVec1VfDn<T, INPUT_T, true, hasAtten, s2BaseSize>(
                ...
                ((runInfo.s1RealSizeAlign32 >> 1) + 63) >> 6 << 6, runInfo.s2AlignedSize, runInfo.s2RealSize,
                static_cast<T>(constInfo.scaleValue), descaleQK, negativeFloatScalar, constInfo.keepProb,
                runInfo.s2LoopCount == runInfo.s2LoopLimit, constInfo.pScale);
        } else {
...
__aicore__ inline void FABlockVecBaseFullquant<TEMPLATE_BASE_ARGS>::BroadCastAndCopyOut(
    RunInfo<isInfer> &runInfo, GlobalTensor<T> &sumGm, GlobalTensor<T> &maxGm, int64_t gmOffset, int64_t calculateSize)
{
    // Copy sum to gm
...
TEMPLATES_DEF_BASE_NO_DEFAULT
__aicore__ inline void FABlockVecBaseFullquant<TEMPLATE_BASE_ARGS>::MlaBoolCopyInRegbase(
        ...
        if (likely(runInfo.s2RealSize == 128)) {
            if (isMlaFullQuantGsize32) {
                ProcessVec1Vf<T, INPUT_T, pseShiftType, false, s1BaseSize, s2BaseSize, EQ_128, hasAtten, pseMode,
                    ...
                    negativeFloatScalar, constInfo.keepProb, queryScaleUb, deSCaleKValue);
            } else {
                ProcessVec1Vf<T, INPUT_T, pseShiftType, false, s1BaseSize, s2BaseSize, EQ_128, hasAtten, pseMode,
                              hasDrop, false, isMlaFullQuant>(
                    stage1CastTensor, this->vselrIndexesBuf, sumUb, maxUb, mmRes, expUb, sumUb, maxUb, attenMaskUb,
                    pseUb, dropMaskUb, apiTmpBuffer, pScaleUb, runInfo.halfS1RealSize, runInfo.s2RealSize,
                    pseInfoPtr->pseStride, slopes, posShift, static_cast<T>(constInfo.scaleValue), descaleQK,
                    negativeFloatScalar, constInfo.keepProb, queryScaleUb, deSCaleKValue);
            ...
            if (isMlaFullQuantGsize32) {
                ProcessVec1Vf<T, INPUT_T, pseShiftType, false, s1BaseSize, s2BaseSize, GT_0_AND_LTE_64, hasAtten,
                              pseMode, hasDrop, true, isMlaFullQuant>(
                    stage1CastTensor, this->vselrIndexesBuf, sumUb, maxUb, mmRes, expUb, sumUb, maxUb, attenMaskUb,
                    pseUb, dropMaskUb, apiTmpBuffer, pScaleUb, runInfo.halfS1RealSize, runInfo.s2RealSize,
                    pseInfoPtr->pseStride, slopes, posShift, static_cast<T>(constInfo.scaleValue), descaleQK,
                    negativeFloatScalar, constInfo.keepProb, queryScaleUb, deSCaleKValue);
                ...
                ProcessVec1Vf<T, INPUT_T, pseShiftType, false, s1BaseSize, s2BaseSize, GT_0_AND_LTE_64, hasAtten,
                              pseMode, hasDrop, false, isMlaFullQuant>(
                    stage1CastTensor, this->vselrIndexesBuf, sumUb, maxUb, mmRes, expUb, sumUb, maxUb, attenMaskUb,
                    pseUb, dropMaskUb, apiTmpBuffer, pScaleUb, runInfo.halfS1RealSize, runInfo.s2RealSize,
                    pseInfoPtr->pseStride, slopes, posShift, static_cast<T>(constInfo.scaleValue), descaleQK,
                    negativeFloatScalar, constInfo.keepProb, queryScaleUb, deSCaleKValue);
...
TEMPLATES_DEF_BASE_NO_DEFAULT
__aicore__ inline void FABlockVecBaseFullquant<TEMPLATE_BASE_ARGS>::ProcessVec2NoGlobalUpdate(
    RunInfo<isInfer> &runInfo, ConstInfo<isInfer, hasRope> &constInfo,
...
TEMPLATES_DEF_BASE_NO_DEFAULT
__aicore__ inline void FABlockVecBaseFullquant<TEMPLATE_BASE_ARGS>::ProcessVec2(mm2ResPos &bmm2ResBuf,
                                                                                RunInfo<isInfer> &runInfo,
                                                                                ConstInfo<isInfer, hasRope> &constInfo)
{
