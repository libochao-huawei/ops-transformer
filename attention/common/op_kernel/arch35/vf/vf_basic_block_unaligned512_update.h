...
PostMaxStage512(__ubuf__ T *&tmpMaxUb, UnalignRegForStore &ureg_max, __ubuf__ T *inMaxUb, __ubuf__ T *tmpMaxUb2,
                RegTensor<float> &vreg_in_max, RegTensor<float> &vreg_input_max, RegTensor<float> &vreg_max_new,
                MaskReg &preg_all, RegTensor<float> &vreg_max, const uint16_t m, __ubuf__ T *srcUb,
                ...
                RegTensor<float> &vreg_input_x7, RegTensor<float> &vreg_input_x8, RegTensor<float> &vreg_exp_even1,
                RegTensor<float> &vreg_exp_odd1, RegTensor<float> &vreg_exp_even2, RegTensor<float> &vreg_exp_odd2,
                RegTensor<float> &vreg_exp_even3, RegTensor<float> &vreg_exp_odd3, RegTensor<float> &vreg_exp_even4,
                RegTensor<float> &vreg_exp_odd4, RegTensor<float> &vreg_exp_sum3, UnalignRegForStore &ureg_exp_sum,
                __ubuf__ T *&tmpExpSumUb, __ubuf__ T2 *expUb1, __ubuf__ T2 *expUb2, __ubuf__ T2 *expUb3,
                __ubuf__ T2 *expUb4, const uint32_t blockStride, const uint32_t repeatStride, MaskReg &preg_n_b16)
{
    ...
    for (uint16_t i = 0; i < m; ++i) {
        ...
        ExpSub8(vreg_exp_even1, vreg_exp_odd1, vreg_exp_even2, vreg_exp_odd2, vreg_exp_even3, vreg_exp_odd3,
                vreg_exp_even4, vreg_exp_odd4, vreg_input_x1, vreg_input_x2, vreg_input_x3, vreg_input_x4,
                vreg_input_x5, vreg_input_x6, vreg_input_x7, vreg_input_x8, vreg_max, preg_all);

        ExpSumReduceStore512<float, T2>(vreg_exp_sum3, vreg_exp_even1, vreg_exp_odd1, vreg_exp_even2, vreg_exp_odd2,
                                        vreg_exp_even3, vreg_exp_odd3, vreg_exp_even4, vreg_exp_odd4, ureg_exp_sum,
                                        tmpExpSumUb, preg_all);

        if constexpr (IsSameType<T2, bfloat16_t>::value) {
            CastStoreExpBf16_512<T2>(vreg_exp_even1, vreg_exp_odd1, vreg_exp_even2, vreg_exp_odd2, vreg_exp_even3,
                                     vreg_exp_odd3, vreg_exp_even4, vreg_exp_odd4, expUb1, expUb2, expUb3, expUb4,
                                     blockStride, repeatStride, preg_all, preg_n_b16);
        } else if constexpr (IsSameType<T2, half>::value) {
            CastStoreExpF16_512<T2>(vreg_exp_even1, vreg_exp_odd1, vreg_exp_even2, vreg_exp_odd2, vreg_exp_even3,
                                    vreg_exp_odd3, vreg_exp_even4, vreg_exp_odd4, expUb1, expUb2, expUb3, expUb4,
                                    blockStride, repeatStride, preg_all, preg_n_b16);
        }
    }
...
__simd_vf__ void ProcessVec1UpdateGeneralImpl512VF(
    ...
    __ubuf__ T *tmpMaxUb, __ubuf__ T *tmpMaxUb2, VREG_FLOAT_MASKUB_8_DECL, const uint32_t nPadding,
    const uint32_t blockStride, const uint32_t repeatStride, const uint32_t oriTailN1, const uint32_t oriTailN2,
    const uint32_t oriTailN3, const uint32_t oriTailN4, const uint32_t tailN1, const uint32_t tailN2,
    const uint32_t tailN3, const uint32_t tailN4, uint32_t pltOriTailN1, uint32_t pltOriTailN2, uint32_t pltOriTailN3,
    uint32_t pltOriTailN4, uint32_t pltTailN1, uint32_t pltTailN2, uint32_t pltTailN3, uint32_t pltTailN4,
    ...
    const T scale, const T minValue)
{
    ...
    VREG_FLOAT_DECL_8(vreg_in_x);
    RegTensor<float> vreg_in_x5_new;
    RegTensor<float> vreg_in_x6_new;
    RegTensor<float> vreg_in_x7_new;
    RegTensor<float> vreg_in_x8_new;
    ...
    if constexpr (pseMode == PseTypeEnum::PSE_INNER_MUL_ADD_TYPE ||
        ...
        InitAlibiOffsets8(vreg_alibi1, vreg_alibi2, vreg_alibi3, vreg_alibi4, vreg_alibi5, vreg_alibi6, vreg_alibi7,
                          vreg_alibi8, posShift, preg_all);
    }
    for (uint16_t i = 0; i < m; ++i) {
        LoadInput8<T>(vreg_in_x1, vreg_in_x2, vreg_in_x3, vreg_in_x4, vreg_in_x5, vreg_in_x6, vreg_in_x7, vreg_in_x8,
                      srcUb, i, s2BaseSize);

        if constexpr (pseMode != PseTypeEnum::PSE_OUTER_ADD_MUL_TYPE) {
            ScaleInput4x4(vreg_in_x1, vreg_in_x2, vreg_in_x3, vreg_in_x4, vreg_in_x5, vreg_in_x6, vreg_in_x7,
                          vreg_in_x8, scale, preg_all, preg_ori_tail_n1, preg_ori_tail_n2, preg_ori_tail_n3,
                          preg_ori_tail_n4);
        }
        if constexpr (pseMode != PseTypeEnum::PSE_NONE_TYPE) {
            ...
            AddPseToInput4x4(vreg_in_x1, vreg_in_x2, vreg_in_x3, vreg_in_x4, vreg_in_x5, vreg_in_x6, vreg_in_x7,
                             vreg_in_x8, vreg_pse1, vreg_pse2, vreg_pse3, vreg_pse4, vreg_pse5, vreg_pse6, vreg_pse7,
                             vreg_pse8, preg_all, preg_ori_tail_n1, preg_ori_tail_n2, preg_ori_tail_n3,
                             preg_ori_tail_n4);
        }
        if constexpr (pseMode == PseTypeEnum::PSE_OUTER_ADD_MUL_TYPE) {
            ScaleInput4x4(vreg_in_x1, vreg_in_x2, vreg_in_x3, vreg_in_x4, vreg_in_x5, vreg_in_x6, vreg_in_x7,
        ...
        if constexpr (hasAtten == 1) {
            // atten mask
            LoadAttenMask8(preg_compare1, preg_compare2, preg_compare3, preg_compare4, preg_compare5, preg_compare6,
                           preg_compare7, preg_compare8, maskUb1, maskUb2, maskUb3, maskUb4, maskUb5, maskUb6, maskUb7,
                           maskUb8, nPadding);

            ApplyAttenMaskSelect8(vreg_sel1, vreg_sel2, vreg_sel3, vreg_sel4, vreg_sel5, vreg_sel6, vreg_sel7,
                                  vreg_sel8, vreg_min, vreg_in_x1, vreg_in_x2, vreg_in_x3, vreg_in_x4, vreg_in_x5,
                                  vreg_in_x6, vreg_in_x7, vreg_in_x8, preg_compare1, preg_compare2, preg_compare3,
                                  preg_compare4, preg_compare5, preg_compare6, preg_compare7, preg_compare8);
            ...
            StoreAlign8<T>(vreg_sel1, vreg_sel2, vreg_sel3, vreg_sel4, vreg_sel5_new, vreg_sel6_new, vreg_sel7_new,
                           vreg_sel8_new, srcUb, i, s2BaseSize, preg_all);

            MaxReduce4(vreg_input_max, vreg_sel1, vreg_sel2, vreg_sel3, vreg_sel4, vreg_sel5_new, vreg_sel6_new,
                       vreg_sel7_new, vreg_sel8_new, preg_all);
        } else {
            Select(vreg_in_x5_new, vreg_in_x5, vreg_min, preg_ori_tail_n1);
            Select(vreg_in_x6_new, vreg_in_x6, vreg_min, preg_ori_tail_n2);
            Select(vreg_in_x7_new, vreg_in_x7, vreg_min, preg_ori_tail_n3);
            Select(vreg_in_x8_new, vreg_in_x8, vreg_min, preg_ori_tail_n4);

            StoreAlign8<T>(vreg_in_x1, vreg_in_x2, vreg_in_x3, vreg_in_x4, vreg_in_x5_new, vreg_in_x6_new,
                           vreg_in_x7_new, vreg_in_x8_new, srcUb, i, s2BaseSize, preg_all);

            MaxReduce4(vreg_input_max, vreg_in_x1, vreg_in_x2, vreg_in_x3, vreg_in_x4, vreg_in_x5_new, vreg_in_x6_new,
    ...
    PostMaxStage512<T, T2, s2BaseSize>(tmpMaxUb, ureg_max, inMaxUb, tmpMaxUb2, vreg_in_max, vreg_input_max,
                                       ...
                                       vreg_in_x4, vreg_in_x5, vreg_in_x6, vreg_in_x7, vreg_in_x8, vreg_exp_even1,
                                       vreg_exp_odd1, vreg_exp_even2, vreg_exp_odd2, vreg_exp_even3, vreg_exp_odd3,
                                       vreg_exp_even4, vreg_exp_odd4, vreg_exp_sum3, ureg_exp_sum, tmpExpSumUb, expUb1,
                                       expUb2, expUb3, expUb4, blockStride, repeatStride, preg_n_b16);
}
...
__simd_vf__ __no_simd_vf_fusion__ void ProcessVec1UpdateGeneralImpl512VFStage1(
    ...
    const T scale, const T minValue)
{
    ProcessVec1TailLoop512<T, T2, OUTPUT_T, s2BaseSize, hasAtten, pseMode>(srcUb, pseUb, maskUb7, maskUb8, nPadding,
                                                                           pltOriTailN3, pltOriTailN4, m, pseStride,
                                                                           slopes, posShift, scale, minValue);
}
...
__simd_vf__ __no_simd_vf_fusion__ void ProcessVec1UpdateGeneralImpl512VFStage2(
    ...
    __ubuf__ T *tmpMaxUb, __ubuf__ T *tmpMaxUb2, VREG_FLOAT_MASKUB_8_DECL, const uint32_t nPadding,
    const uint32_t blockStride, const uint32_t repeatStride, const uint32_t oriTailN1, const uint32_t oriTailN2,
    const uint32_t tailN2, const uint32_t oriTailN3, const uint32_t oriTailN4, const uint32_t tailN1,
    const uint32_t tailN3, const uint32_t tailN4, uint32_t pltOriTailN1, uint32_t pltOriTailN2, uint32_t pltOriTailN3,
    uint32_t pltOriTailN4, uint32_t pltTailN1, uint32_t pltTailN2, uint32_t pltTailN3, uint32_t pltTailN4,
    float divValue, uint32_t pltN, const uint16_t m, const uint32_t pseStride, const float slopes, const float posShift,
    const T scale, const T minValue)
{
    ...
    VREG_FLOAT_DECL_8(vreg_x_in);
    RegTensor<float> vreg_x_in5_new;
    RegTensor<float> vreg_x_in6_new;
    RegTensor<float> vreg_x_in7_new;
    RegTensor<float> vreg_x_in8_new;
    RegTensor<float> vreg_in_max;
    RegTensor<float> vreg_exp_sum3;
    RegTensor<float> vreg_max;
    VREG_FLOAT_DECL_EXP_PAIRS_4(vreg_exp);
    ...
    if constexpr (pseMode == PseTypeEnum::PSE_INNER_MUL_ADD_TYPE ||
                  pseMode == PseTypeEnum::PSE_INNER_MUL_ADD_SQRT_TYPE) {
        InitAlibiOffsets6(vreg_alibi1, vreg_alibi2, vreg_alibi3, vreg_alibi4, vreg_alibi5, vreg_alibi6, posShift,
                          preg_all);
    }
    for (uint16_t i = 0; i < m; ++i) {
        LoadInput6<T>(vreg_x_in1, vreg_x_in2, vreg_x_in3, vreg_x_in4, vreg_x_in5, vreg_x_in6, srcUb, i, s2BaseSize);

        if constexpr (pseMode != PseTypeEnum::PSE_OUTER_ADD_MUL_TYPE) {
            ScaleInput4x2(vreg_x_in1, vreg_x_in2, vreg_x_in3, vreg_x_in4, vreg_x_in5, vreg_x_in6, scale, preg_all,
        ...
        if constexpr (pseMode != PseTypeEnum::PSE_NONE_TYPE) {
            ...
            AddPseToInput4x2(vreg_x_in1, vreg_x_in2, vreg_x_in3, vreg_x_in4, vreg_x_in5, vreg_x_in6, vreg_pse1,
                             vreg_pse2, vreg_pse3, vreg_pse4, vreg_pse5, vreg_pse6, preg_all, preg_ori_tail_n1,
                             preg_ori_tail_n2);
        }
        if constexpr (pseMode == PseTypeEnum::PSE_OUTER_ADD_MUL_TYPE) {
            ScaleInput4x2(vreg_x_in1, vreg_x_in2, vreg_x_in3, vreg_x_in4, vreg_x_in5, vreg_x_in6, scale, preg_all,
        ...
        if constexpr (hasAtten == 1) {
            // atten mask
            LoadAttenMask6(preg_compare1, preg_compare2, preg_compare3, preg_compare4, preg_compare5, preg_compare6,
                           maskUb1, maskUb2, maskUb3, maskUb4, maskUb5, maskUb6, nPadding);

            ApplyAttenMaskSelect6(vreg_sel1, vreg_sel2, vreg_sel3, vreg_sel4, vreg_sel5, vreg_sel6, vreg_min,
                                  vreg_x_in1, vreg_x_in2, vreg_x_in3, vreg_x_in4, vreg_x_in5, vreg_x_in6, preg_compare1,
                                  preg_compare2, preg_compare3, preg_compare4, preg_compare5, preg_compare6);
            ...
            StoreAlign6<T>(vreg_sel1, vreg_sel2, vreg_sel3, vreg_sel4, vreg_sel5_new, vreg_sel6_new, srcUb, i,
                           s2BaseSize, preg_all);

            MaxReduce4(vreg_input_max, vreg_sel1, vreg_sel2, vreg_sel3, vreg_sel4, vreg_sel5_new, vreg_sel6_new,
                       vreg_sel7_new, vreg_sel8_new, preg_all);
        } else {
            Select(vreg_x_in5_new, vreg_x_in5, vreg_min, preg_ori_tail_n1);
            Select(vreg_x_in6_new, vreg_x_in6, vreg_min, preg_ori_tail_n2);
            LoadAlign(vreg_x_in7_new, srcUb + floatRepSize * 6 + i * s2BaseSize);
            LoadAlign(vreg_x_in8_new, srcUb + floatRepSize * 7 + i * s2BaseSize);

            StoreAlign6<T>(vreg_x_in1, vreg_x_in2, vreg_x_in3, vreg_x_in4, vreg_x_in5_new, vreg_x_in6_new, srcUb, i,
                           s2BaseSize, preg_all);

            MaxReduce4(vreg_input_max, vreg_x_in1, vreg_x_in2, vreg_x_in3, vreg_x_in4, vreg_x_in5_new, vreg_x_in6_new,
    ...
    PostMaxStage512<T, T2, s2BaseSize>(tmpMaxUb, ureg_max, inMaxUb, tmpMaxUb2, vreg_in_max, vreg_input_max,
                                       ...
                                       vreg_x_in4, vreg_x_in5, vreg_x_in6, vreg_x_in7, vreg_x_in8, vreg_exp_even1,
                                       vreg_exp_odd1, vreg_exp_even2, vreg_exp_odd2, vreg_exp_even3, vreg_exp_odd3,
                                       vreg_exp_even4, vreg_exp_odd4, vreg_exp_sum3, ureg_exp_sum, tmpExpSumUb, expUb1,
                                       expUb2, expUb3, expUb4, blockStride, repeatStride, preg_n_b16);
}
    ...
    const T minValue, float keepProb)
{
    ...
    if constexpr (pseMode != PseTypeEnum::PSE_NONE_TYPE && hasAtten == 1) { // 同时具备pse和mask特性
        ProcessVec1UpdateGeneralImpl512VFStage1<T, T2, OUTPUT_T, s1BaseSize, s2BaseSize, hasAtten, pseMode, hasDrop,
                                                isMlaSgd>(
            ...
            oriTailN1, oriTailN2, oriTailN3, oriTailN4, tailN1, tailN2, tailN3, tailN4, pltOriTailN1, pltOriTailN2,
            pltOriTailN3, pltOriTailN4, pltTailN1, pltTailN2, pltTailN3, pltTailN4, divValue, pltN, m, pseStride,
            slopes, posShift, scale, minValue);
        ProcessVec1UpdateGeneralImpl512VFStage2<T, T2, OUTPUT_T, s1BaseSize, s2BaseSize, hasAtten, pseMode, hasDrop,
                                                isMlaSgd>(
            expUb1, expUb2, expUb3, expUb4, pseUb, maxUb, srcUb, expMaxUb, inMaxUb, tmpExpSumUb, tmpMaxUb, tmpMaxUb2,
            maskUb1, maskUb2, maskUb3, maskUb4, maskUb5, maskUb6, maskUb7, maskUb8, nPadding, blockStride, repeatStride,
            oriTailN1, oriTailN2, oriTailN3, oriTailN4, tailN1, tailN2, tailN3, tailN4, pltOriTailN1, pltOriTailN2,
        ...
        ProcessVec1UpdateGeneralImpl512VF<T, T2, OUTPUT_T, s1BaseSize, s2BaseSize, hasAtten, pseMode, hasDrop,
                                          isMlaSgd>(
            expUb1, expUb2, expUb3, expUb4, pseUb, maxUb, srcUb, expMaxUb, inMaxUb, tmpExpSumUb, tmpMaxUb, tmpMaxUb2,
            maskUb1, maskUb2, maskUb3, maskUb4, maskUb5, maskUb6, maskUb7, maskUb8, nPadding, blockStride, repeatStride,
            oriTailN1, oriTailN2, oriTailN3, oriTailN4, tailN1, tailN2, tailN3, tailN4, pltOriTailN1, pltOriTailN2,
