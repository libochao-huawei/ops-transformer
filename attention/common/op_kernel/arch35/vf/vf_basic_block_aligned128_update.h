    ...
    const float deSCaleKValue = 1.0f, const float sinkValue = 0.0f)
{
    ...
    ProcessVec1UpdateImpl128VF<T, T2, pseShiftType, s1BaseSize, s2BaseSize, hasAtten, pseMode, hasDrop, isMlaSgd,
                               isMlaFullQuant, hasSink>(
        expUb, x_expUb, pseUb, maxUb, srcUb, expMaxUb, inMaxUb, tmpExpSumUb, tmpMaxUb, tmpMaxUb2, qScaleUb, pScaleUb,
        indexesUb, maskUb, maskUbUnroll, dropMaskUb, divValue, blockStride, repeatStride, dScale, m, pseStride, slopes,
        posShift, scale, dScaleQK, minValue, deSCaleKValue, sinkValue);
}
} // namespace FaVectorApi
