                   ...
                   const uint32_t blockStride, const uint32_t repeatStride, MaskReg &preg_all, MaskReg &preg_all_b16)
{
    ...
    for (uint16_t i = 0; i < m; ++i) {
        ...
        ExpSub8(vreg_exp_even1, vreg_exp_odd1, vreg_exp_even2, vreg_exp_odd2, vreg_exp_even3, vreg_exp_odd3,
                ...
                vreg_input_x5, vreg_input_x6, vreg_input_x7, vreg_input_x8, vreg_max_brc, preg_all);
    ...
    const float posShift, const T scale, const T minValue)
{
    ...
    VREG_FLOAT_DECL_8(vreg_src_x);
    RegTensor<float> vreg_src_x5_new;
    RegTensor<float> vreg_src_x6_new;
    RegTensor<float> vreg_src_x7_new;
    RegTensor<float> vreg_src_x8_new;
    ...
    for (uint16_t i = 0; i < m; ++i) {
        LoadInput8<T>(vreg_src_x1, vreg_src_x2, vreg_src_x3, vreg_src_x4, vreg_src_x5, vreg_src_x6, vreg_src_x7,
                      vreg_src_x8, srcUb, i, s2BaseSize);

        if constexpr (pseMode != PseTypeEnum::PSE_OUTER_ADD_MUL_TYPE) {
            ScaleInput4x4(vreg_src_x1, vreg_src_x2, vreg_src_x3, vreg_src_x4, vreg_src_x5, vreg_src_x6, vreg_src_x7,
                          vreg_src_x8, scale, preg_all, preg_ori_tail_n1, preg_ori_tail_n2, preg_ori_tail_n3,
                          preg_ori_tail_n4);
        }
        if constexpr (pseMode != PseTypeEnum::PSE_NONE_TYPE) {
            ...
            AddPseToInput4x4(vreg_src_x1, vreg_src_x2, vreg_src_x3, vreg_src_x4, vreg_src_x5, vreg_src_x6, vreg_src_x7,
                             vreg_src_x8, vreg_pse1, vreg_pse2, vreg_pse3, vreg_pse4, vreg_pse5, vreg_pse6, vreg_pse7,
        ...
        if constexpr (hasAtten == 1) {
            ...
            ApplyAttenMaskSelect8(vreg_sel1, vreg_sel2, vreg_sel3, vreg_sel4, vreg_sel5, vreg_sel6, vreg_sel7,
                                  vreg_sel8, vreg_min, vreg_src_x1, vreg_src_x2, vreg_src_x3, vreg_src_x4, vreg_src_x5,
                                  vreg_src_x6, vreg_src_x7, vreg_src_x8, preg_compare1, preg_compare2, preg_compare3,
            ...
            Select(vreg_src_x5_new, vreg_src_x5, vreg_min, preg_ori_tail_n1);
            Select(vreg_src_x6_new, vreg_src_x6, vreg_min, preg_ori_tail_n2);
            Select(vreg_src_x7_new, vreg_src_x7, vreg_min, preg_ori_tail_n3);
            Select(vreg_src_x8_new, vreg_src_x8, vreg_min, preg_ori_tail_n4);

            StoreAlign8<T>(vreg_src_x1, vreg_src_x2, vreg_src_x3, vreg_src_x4, vreg_src_x5_new, vreg_src_x6_new,
                           vreg_src_x7_new, vreg_src_x8_new, srcUb, i, s2BaseSize, preg_all);

            MaxReduce4(vreg_input_max, vreg_src_x1, vreg_src_x2, vreg_src_x3, vreg_src_x4, vreg_src_x5_new,
    ...
    PostReduceStage512<T, T2, s2BaseSize>(
        ...
        vreg_src_x5, vreg_src_x6, vreg_src_x7, vreg_src_x8, vreg_exp_even1, vreg_exp_odd1, vreg_exp_even2,
        vreg_exp_odd2, vreg_exp_even3, vreg_exp_odd3, vreg_exp_even4, vreg_exp_odd4, vreg_exp_sum3, ureg_exp_sum,
        expSumUb, expUb1, expUb2, expUb3, expUb4, blockStride, repeatStride, preg_all, preg_all_b16);
}
...
__simd_vf__ __no_simd_vf_fusion__ void ProcessVec1NoUpdateGeneralImpl512VFStage2(
    ...
    const float posShift, const T scale, const T minValue)
{
    VREG_FLOAT_DECL_8(vreg_x_src);
    RegTensor<float> vreg_x_src5_new;
    RegTensor<float> vreg_x_src6_new;
    RegTensor<float> vreg_x_src7_new;
    RegTensor<float> vreg_x_src8_new;
    RegTensor<float> vreg_min;
    ...
    for (uint16_t i = 0; i < m; ++i) {
        LoadInput6<T>(vreg_x_src1, vreg_x_src2, vreg_x_src3, vreg_x_src4, vreg_x_src5, vreg_x_src6, srcUb, i,
                      s2BaseSize);

        if constexpr (pseMode != PseTypeEnum::PSE_OUTER_ADD_MUL_TYPE) {
            ScaleInput4x2(vreg_x_src1, vreg_x_src2, vreg_x_src3, vreg_x_src4, vreg_x_src5, vreg_x_src6, scale, preg_all,
        ...
        if constexpr (pseMode != PseTypeEnum::PSE_NONE_TYPE) {
            ...
            AddPseToInput4x2(vreg_x_src1, vreg_x_src2, vreg_x_src3, vreg_x_src4, vreg_x_src5, vreg_x_src6, vreg_pse1,
        ...
        if constexpr (hasAtten == 1) {
            ...
            ApplyAttenMaskSelect6(vreg_sel1, vreg_sel2, vreg_sel3, vreg_sel4, vreg_sel5, vreg_sel6, vreg_min,
                                  vreg_x_src1, vreg_x_src2, vreg_x_src3, vreg_x_src4, vreg_x_src5, vreg_x_src6,
                                  preg_compare1, preg_compare2, preg_compare3, preg_compare4, preg_compare5,
                                  preg_compare6);
            ...
            Select(vreg_x_src5_new, vreg_x_src5, vreg_min, preg_ori_tail_n1);
            Select(vreg_x_src6_new, vreg_x_src6, vreg_min, preg_ori_tail_n2);
            LoadAlign(vreg_x_src7_new, srcUb + floatRepSize * 6 + i * s2BaseSize);
            LoadAlign(vreg_x_src8_new, srcUb + floatRepSize * 7 + i * s2BaseSize);

            StoreAlign6<T>(vreg_x_src1, vreg_x_src2, vreg_x_src3, vreg_x_src4, vreg_x_src5_new, vreg_x_src6_new, srcUb,
                           i, s2BaseSize, preg_all);
    ...
    PostReduceStage512<T, T2, s2BaseSize>(
        ...
        vreg_x_src5, vreg_x_src6, vreg_x_src7, vreg_x_src8, vreg_exp_even1, vreg_exp_odd1, vreg_exp_even2,
        vreg_exp_odd2, vreg_exp_even3, vreg_exp_odd3, vreg_exp_even4, vreg_exp_odd4, vreg_exp_sum3, ureg_exp_sum,
        expSumUb, expUb1, expUb2, expUb3, expUb4, blockStride, repeatStride, preg_all, preg_all_b16);
}
    ...
    const T minValue, float keepProb)
{
    ...
    if constexpr (pseMode != PseTypeEnum::PSE_NONE_TYPE && hasAtten == 1) {
        ProcessVec1NoUpdateGeneralImpl512VFStage1<T, T2, OUTPUT_T, s1BaseSize, s2BaseSize, hasAtten, pseMode, hasDrop>(
            expUb1, expUb2, expUb3, expUb4, pseUb, expSumUb, maxUb, maxUbStart, srcUb, maskUb1, maskUb2, maskUb3,
            maskUb4, maskUb5, maskUb6, maskUb7, maskUb8, nPadding, blockStride, repeatStride, oriTailN1, oriTailN2,
            oriTailN3, oriTailN4, tailN1, tailN2, tailN3, tailN4, pltOriTailN1, pltOriTailN2, pltOriTailN3,
            pltOriTailN4, pltTailN1, pltTailN2, pltTailN3, pltTailN4, divValue, m, pseStride, slopes, posShift, scale,
            minValue);
