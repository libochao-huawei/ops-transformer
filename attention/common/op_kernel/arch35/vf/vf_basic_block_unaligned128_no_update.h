...
__simd_vf__ void ProcessVec1NoUpdateGeneralImpl128VF(
    ...
    __ubuf__ uint32_t *maskUb, __ubuf__ uint32_t *maskUbUnroll, __ubuf__ uint32_t *dropMaskUb, const uint32_t nPadding,
    ...
    const float sinkValue = 0.0f)
{
    ...
    ProcessVec1NoUpdateGeneralImpl128VF<T, T2, pseShiftType, s1BaseSize, s2BaseSize, hasAtten, pseMode, hasDrop,
        ...
        dropMaskUb, nPadding, blockStride, repeatStride, oriTailN, tailN, dScale, pltOriTailN, pltTailN, divValue, m,
