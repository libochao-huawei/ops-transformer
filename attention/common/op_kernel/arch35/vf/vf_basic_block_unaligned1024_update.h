...
__simd_vf__ void ProcessVec1UpdateGeneralImpl1024VF(
    ...
    __ubuf__ T2 *expUb6, __ubuf__ T2 *expUb7, __ubuf__ T2 *expUb8, __ubuf__ OUTPUT_T *pseUb, __ubuf__ T *maxUb,
    __ubuf__ T *srcUb, __ubuf__ T *expMaxUb, __ubuf__ T *inMaxUb, __ubuf__ T *tmpExpSumUb, __ubuf__ T *tmpMaxUb,
    __ubuf__ T *tmpMaxUb2, VREG_FLOAT_MASKUB_16_DECL, const uint32_t nPadding, const uint32_t blockStride,
    const uint32_t repeatStride, const uint32_t oriTailN1, const uint32_t oriTailN2, const uint32_t oriTailN3,
    const uint32_t oriTailN4, const uint32_t oriTailN5, const uint32_t oriTailN6, const uint32_t oriTailN7,
    const uint32_t oriTailN8, const uint32_t tailN1, const uint32_t tailN2, const uint32_t tailN3,
    const uint32_t tailN4, const uint32_t tailN5, const uint32_t tailN6, const uint32_t tailN7, const uint32_t tailN8,
    uint32_t pltOriTailN1, uint32_t pltOriTailN2, uint32_t pltOriTailN3, uint32_t pltOriTailN4, uint32_t pltOriTailN5,
    uint32_t pltOriTailN6, uint32_t pltOriTailN7, uint32_t pltOriTailN8, uint32_t pltTailN1, uint32_t pltTailN2,
    uint32_t pltTailN3, uint32_t pltTailN4, uint32_t pltTailN5, uint32_t pltTailN6, uint32_t pltTailN7,
    uint32_t pltTailN8, uint32_t pltN, float divValue, const uint16_t m, const uint32_t pseStride, const float slopes,
    const float posShift, const T scale, const T minValue)
{
    ...
    ProcessVec1MainLoop1024<T, T2, hasAtten, pseMode>(
        ...
        tmpMaxUb, pseUb, maskUb1, maskUb2, maskUb3, maskUb4, maskUb5, maskUb6, maskUb7, maskUb8, maskUb9, maskUb10,
    ...
    for (uint16_t i = 0; i < m; ++i) {
        ...
        ExpSub16(vreg_exp_even1, vreg_exp_odd1, vreg_exp_even2, vreg_exp_odd2, vreg_exp_even3, vreg_exp_odd3,
                 ...
                 vreg_input_x15, vreg_input_x16, vreg_max, preg_all);
        ...
        ExpSumReduceStore1024<float, T2>(vreg_exp_sum1, vreg_exp_even1, vreg_exp_odd1, vreg_exp_even2, vreg_exp_odd2,
                                         ...
                                         vreg_exp_even8, vreg_exp_odd8, ureg_exp_sum, tmpExpSumUb, preg_all);
    ...
    const T minValue, float keepProb)
{
    ...
    ProcessVec1UpdateGeneralImpl1024VF<T, T2, OUTPUT_T, s1BaseSize, s2BaseSize, hasAtten, pseMode, hasDrop>(
        expUb1, expUb2, expUb3, expUb4, expUb5, expUb6, expUb7, expUb8, pseUb, maxUb, srcUb, expMaxUb, inMaxUb,
        tmpExpSumUb, tmpMaxUb, tmpMaxUb2, maskUb1, maskUb2, maskUb3, maskUb4, maskUb5, maskUb6, maskUb7, maskUb8,
        maskUb9, maskUb10, maskUb11, maskUb12, maskUb13, maskUb14, maskUb15, maskUb16, nPadding, blockStride,
        repeatStride, oriTailN1, oriTailN2, oriTailN3, oriTailN4, oriTailN5, oriTailN6, oriTailN7, oriTailN8, tailN1,
        tailN2, tailN3, tailN4, tailN5, tailN6, tailN7, tailN8, pltOriTailN1, pltOriTailN2, pltOriTailN3, pltOriTailN4,
        pltOriTailN5, pltOriTailN6, pltOriTailN7, pltOriTailN8, pltTailN1, pltTailN2, pltTailN3, pltTailN4, pltTailN5,
        pltTailN6, pltTailN7, pltTailN8, pltN, divValue, m, pseStride, slopes, posShift, scale, minValue);
}
} // namespace FaVectorApi
