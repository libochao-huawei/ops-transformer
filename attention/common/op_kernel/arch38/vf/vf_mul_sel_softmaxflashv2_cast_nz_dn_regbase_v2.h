                               ...
                               const T scale, const T minValue, float quantScale1)
{
    ...
    __VEC_SCOPE__
    {
        ...
        for (uint16_t i = originN; i < ubN; ++i) {
            MicroAPI::DataCopy<T, MicroAPI::StoreDist::DIST_NORM_B32>((__ubuf__ T *)input_x_local_UB + i * m, vreg_min,
                                                                      preg_135);
        ...
        for (uint16_t iter_m = 0; iter_m < uint16_t(ubN / 8); ++iter_m) {
            ...
            MicroAPI::DataCopy<T, MicroAPI::LoadDist::DIST_NORM>(src_00a, src0_ub, aReg);
            MicroAPI::Max<T, MicroAPI::MaskMergeMode::ZEROING>(max_0a, max_0a, src_00a, preg_108);
            MicroAPI::DataCopy<T, MicroAPI::LoadDist::DIST_NORM>(src_00b, src0_ub_1, aReg);
            MicroAPI::Max<T, MicroAPI::MaskMergeMode::ZEROING>(max_0b, max_0b, src_00b, preg_108);
            MicroAPI::DataCopy<T, MicroAPI::LoadDist::DIST_NORM>(src_01a, src0_ub1, aReg);
            MicroAPI::Max<T, MicroAPI::MaskMergeMode::ZEROING>(max_1a, max_1a, src_01a, preg_108);
            MicroAPI::DataCopy<T, MicroAPI::LoadDist::DIST_NORM>(src_01b, src0_ub1_1, aReg);
            MicroAPI::Max<T, MicroAPI::MaskMergeMode::ZEROING>(max_1b, max_1b, src_01b, preg_108);
            MicroAPI::DataCopy<T, MicroAPI::LoadDist::DIST_NORM>(src_02a, src0_ub2, aReg);
            MicroAPI::Max<T, MicroAPI::MaskMergeMode::ZEROING>(max_2a, max_2a, src_02a, preg_108);
            MicroAPI::DataCopy<T, MicroAPI::LoadDist::DIST_NORM>(src_02b, src0_ub2_1, aReg);
            MicroAPI::Max<T, MicroAPI::MaskMergeMode::ZEROING>(max_2b, max_2b, src_02b, preg_108);
            MicroAPI::DataCopy<T, MicroAPI::LoadDist::DIST_NORM>(src_03a, src0_ub3, aReg);
            MicroAPI::Max<T, MicroAPI::MaskMergeMode::ZEROING>(max_3a, max_3a, src_03a, preg_108);
            MicroAPI::DataCopy<T, MicroAPI::LoadDist::DIST_NORM>(src_03b, src0_ub3_1, aReg);
            MicroAPI::Max<T, MicroAPI::MaskMergeMode::ZEROING>(max_3b, max_3b, src_03b, preg_108);
        }
        ...
        MicroAPI::Max<T, MicroAPI::MaskMergeMode::ZEROING>(max_2a, max_2a, max_3a, preg_108);
        MicroAPI::Max<T, MicroAPI::MaskMergeMode::ZEROING>(max_2b, max_2b, max_3b, preg_108);
        MicroAPI::Max<T, MicroAPI::MaskMergeMode::ZEROING>(max_0a, max_0a, max_2a, preg_108);
        MicroAPI::Max<T, MicroAPI::MaskMergeMode::ZEROING>(max_0b, max_0b, max_2b, preg_108);
        ...
        MicroAPI::DataCopy<T, MicroAPI::StoreDist::DIST_NORM_B32>((__ubuf__ T *)new_global_max, max_0a, preg_108);
        ...
        for (uint16_t i0 = 0; i0 < uint16_t(ubN / 4); ++i0) {
            ...
            MicroAPI::DataCopy<T, MicroAPI::LoadDist::DIST_NORM>(vreg_x_f32_a, ((__ubuf__ T *)input_x_local_UB), aReg);
            MicroAPI::DataCopy<T, MicroAPI::LoadDist::DIST_NORM>(vreg_x_f32_b,
                                                                 ((__ubuf__ T *)input_x_local_UB + ubN * m / 2), aReg);
            MicroAPI::DataCopy<T, MicroAPI::LoadDist::DIST_NORM>(vreg_x_f32_1_a,
                                                                 ((__ubuf__ T *)input_x_local_UB + ubN * m / 4), aReg);
            ...
            MicroAPI::Muls<half, half, MicroAPI::MaskMergeMode::ZEROING>(vreg_muls_res_even, vreg_x_exp_even,
                                                                         (half)quantScale1, preg_all_b16);
            MicroAPI::Muls<half, half, MicroAPI::MaskMergeMode::ZEROING>(vreg_muls_res_odd, vreg_x_exp_odd,
                                                                         (half)quantScale1, preg_all_b16);

            MicroAPI::Muls<T, T, MicroAPI::MaskMergeMode::ZEROING>(vreg_x_f32_1_a, vreg_x_f32_1_a, scale, preg_108);
            MicroAPI::Muls<T, T, MicroAPI::MaskMergeMode::ZEROING>(vreg_x_f32_1_b, vreg_x_f32_1_b, scale, preg_108);

            MicroAPI::FusedExpSub<T, T, MicroAPI::RegLayout::ONE, MicroAPI::MaskMergeMode::ZEROING>(
                vreg_x_exp_even_1, vreg_x_f32_1_a, max_0a, preg_134);
            MicroAPI::FusedExpSub<T, T, MicroAPI::RegLayout::ONE, MicroAPI::MaskMergeMode::ZEROING>(
                vreg_x_exp_odd_1, vreg_x_f32_1_b, max_0a, preg_134);
            MicroAPI::Muls<half, half, MicroAPI::MaskMergeMode::ZEROING>(vreg_muls_res_even_1, vreg_x_exp_even_1,
                                                                         (half)quantScale1, preg_all_b16);
            MicroAPI::Muls<half, half, MicroAPI::MaskMergeMode::ZEROING>(vreg_muls_res_odd_1, vreg_x_exp_odd_1,
                                                                         (half)quantScale1, preg_all_b16);
            ...
            MicroAPI::Add<T, MicroAPI::MaskMergeMode::ZEROING>(vreg_x_sum_1_even, vreg_x_exp_even_1, vreg_x_sum_1_even,
                                                               preg_134);
            MicroAPI::Add<T, MicroAPI::MaskMergeMode::ZEROING>(vreg_x_sum_1_odd, vreg_x_exp_odd_1, vreg_x_sum_1_odd,
                                                               preg_134);
        }
        MicroAPI::Add<T, MicroAPI::MaskMergeMode::ZEROING>(vreg_x_sum0, vreg_x_sum_odd, vreg_x_sum_even, preg_134);
        MicroAPI::Add<T, MicroAPI::MaskMergeMode::ZEROING>(vreg_x_sum1, vreg_x_sum_1_odd, vreg_x_sum_1_even, preg_134);
        ...
        MicroAPI::DataCopy<float, MicroAPI::StoreDist::DIST_INTLV_B32>(new_global_sum, vreg_x_sum0_even,
                                                                       vreg_x_sum0_odd, preg_all_b32);
    }
}
                             ...
                             const T scale, const T minValue, float quantScale1)
{
    ...
    __VEC_SCOPE__
    {
        ...
        MicroAPI::DataCopy<T, MicroAPI::LoadDist::DIST_NORM>(vreg_x_max_f16, ((__ubuf__ T *)new_global_max));
        MicroAPI::Max<T, MicroAPI::MaskMergeMode::ZEROING>(max_0a, max_0a, max_1a, preg_108);
        MicroAPI::Max<T, MicroAPI::MaskMergeMode::ZEROING>(max_0b, max_0b, max_1b, preg_108);
        MicroAPI::Max<T, MicroAPI::MaskMergeMode::ZEROING>(max_2a, max_2a, max_3a, preg_108);
        MicroAPI::Max<T, MicroAPI::MaskMergeMode::ZEROING>(max_2b, max_2b, max_3b, preg_108);
        ...
        MicroAPI::Max<T, MicroAPI::MaskMergeMode::ZEROING>(max_0a, max_0a, max_0b, preg_108);
        MicroAPI::Muls<T, T, MicroAPI::MaskMergeMode::ZEROING>(max_0a, max_0a, scale, preg_108);
        MicroAPI::Max<T, MicroAPI::MaskMergeMode::ZEROING>(max_0a, max_0a, vreg_x_max_f16, preg_108);

        MicroAPI::FusedExpSub<T, T, MicroAPI::RegLayout::ONE, MicroAPI::MaskMergeMode::ZEROING>(
            vreg_x_max_f16, vreg_x_max_f16, max_0a, preg_134);
        MicroAPI::DataCopy<T, MicroAPI::StoreDist::DIST_NORM_B32>((__ubuf__ T *)new_global_max, max_0a, preg_108);
        static constexpr MicroAPI::CastTrait castTrait0 = {MicroAPI::RegLayout::ZERO, MicroAPI::SatMode::UNKNOWN,
                                                           MicroAPI::MaskMergeMode::ZEROING, RoundMode::UNKNOWN};
        static constexpr MicroAPI::CastTrait castTrait1 = {MicroAPI::RegLayout::ONE, MicroAPI::SatMode::UNKNOWN,
        ...
        MicroAPI::DataCopy<float, MicroAPI::StoreDist::DIST_INTLV_B32>(exp_max_fp32, vreg_x_max_f32_even,
                                                                       vreg_x_max_f32_odd, preg_all_b32);
        ...
        MicroAPI::DataCopy<float, MicroAPI::LoadDist::DIST_DINTLV_B32>(vreg_l0, vreg_l0_1,
                                                                       ((__ubuf__ float *)new_global_sum));
        MicroAPI::DataCopy<float, MicroAPI::LoadDist::DIST_DINTLV_B32>(vreg_x_max_f32, vreg_x_max_f32_1,
                                                                       ((__ubuf__ float *)exp_max_fp32));
        MicroAPI::Mul<float, MicroAPI::MaskMergeMode::ZEROING>(vreg_l0, vreg_x_max_f32, vreg_l0, preg_all_b32);
        MicroAPI::Mul<float, MicroAPI::MaskMergeMode::ZEROING>(vreg_l0_1, vreg_x_max_f32_1, vreg_l0_1, preg_all_b32);
        MicroAPI::Add<float, MicroAPI::MaskMergeMode::ZEROING>(vreg_l0, vreg_l0, vreg_x_sum0_even, preg_all_b32);
        MicroAPI::Add<float, MicroAPI::MaskMergeMode::ZEROING>(vreg_l0_1, vreg_l0_1, vreg_x_sum0_odd, preg_all_b32);
        MicroAPI::DataCopy<float, MicroAPI::StoreDist::DIST_INTLV_B32>(new_global_sum, vreg_l0, vreg_l0_1,
                                                                       preg_all_b32);
    }
}
