...
/*!
 * \file quant_sparse_flash_mla_metadata_aicpu.h
 * \brief
 */

#ifndef quant_sparse_flash_mla_metadata_AICPU_H
#define quant_sparse_flash_mla_metadata_AICPU_H
...
class QuantSparseFlashMlaMetadataCpuKernel : public CpuKernel {
public:
    QuantSparseFlashMlaMetadataCpuKernel() = default;
    ~QuantSparseFlashMlaMetadataCpuKernel() = default;
...
private:
    ...
    // paramsCheck
    bool ParamsCheck();
    bool CheckCuSeqLen(int32_t batchSize);
    bool CheckSeqLen(int32_t batchSize);
    bool CheckTopkLength(int32_t batchSize);
    bool CheckFeature(int32_t batchSize);
