...
/*!
 * \file mhc_pre_sinkhorn_premix_tiling.h
 * \brief MhcPreSinkhornPremix tiling
 */

#ifndef MHC_PRE_SINKHORN_PREMIX_TILING_H
#define MHC_PRE_SINKHORN_PREMIX_TILING_H
...
BEGIN_TILING_DATA_DEF(MhcPreSinkhornPremixTilingData)
...
REGISTER_TILING_DATA_CLASS(MhcPreSinkhornPremix, MhcPreSinkhornPremixTilingData)

// Regbase TilingData
BEGIN_TILING_DATA_DEF(MhcPreSinkhornPremixRegbaseTilingData)
...
TILING_DATA_FIELD_DEF(int64_t, hasPremix); // 是否传入premix可选输入（仅Ascend950支持）
END_TILING_DATA_DEF;

REGISTER_TILING_DATA_CLASS(MhcPreSinkhornPremix_1000, MhcPreSinkhornPremixRegbaseTilingData)
REGISTER_TILING_DATA_CLASS(MhcPreSinkhornPremix_1001, MhcPreSinkhornPremixRegbaseTilingData)
REGISTER_TILING_DATA_CLASS(MhcPreSinkhornPremix_2000, MhcPreSinkhornPremixRegbaseTilingData)
REGISTER_TILING_DATA_CLASS(MhcPreSinkhornPremix_2001, MhcPreSinkhornPremixRegbaseTilingData)

struct MhcPreSinkhornPremixCompileInfo {
    uint64_t coreNum = 0;
...
class MhcPreSinkhornPremixTiling {
public:
    explicit MhcPreSinkhornPremixTiling(gert::TilingContext *tilingContext)
        : context_(tilingContext)
    {}
    ~MhcPreSinkhornPremixTiling() = default;
...
private:
    ...
    MhcPreSinkhornPremixTilingData tilingData_;
...
class MhcPreSinkhornPremixTilingRegbase {
public:
    explicit MhcPreSinkhornPremixTilingRegbase(gert::TilingContext *tilingContext);
    ~MhcPreSinkhornPremixTilingRegbase() = default;
...
private:
    ...
    ge::graphStatus CalcRegbaseCommonTiling(GradOutMode gradOutMode, SplitMode splitMode);

    gert::TilingContext *context_ = nullptr;
    uint64_t tilingKey_ = 0;
    MhcPreSinkhornPremixRegbaseTilingData tilingData_;
    uint64_t aivCoreNum_ = 0;
    uint64_t aicCoreNum_ = 0;
    uint64_t workspaceSize_ = 0;
...
#endif // MHC_PRE_SINKHORN_PREMIX_TILING_H
