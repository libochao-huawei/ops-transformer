...
/*!
 * \file mhc_pre_sinkhorn_premix_m_split_core_arch35.h
 * \brief
 */

#ifndef MHC_PRE_SINKHORN_PREMIX_M_SPLIT_CORE_ARCH35_H
#define MHC_PRE_SINKHORN_PREMIX_M_SPLIT_CORE_ARCH35_H
...
template <typename T>
class MhcPreSinkhornPremixMSplitCorePart1 {
public:
    __aicore__ inline MhcPreSinkhornPremixMSplitCorePart1() {}
