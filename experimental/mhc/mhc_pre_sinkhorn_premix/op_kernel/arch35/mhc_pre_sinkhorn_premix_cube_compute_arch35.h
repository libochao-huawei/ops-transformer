...
/*!
 * \file mhc_pre_sinkhorn_premix_cube_compute_arch35.h
 * \brief
 */
#ifndef MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_ARCH35_H
#define MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_ARCH35_H
...
class MhcPreSinkhornPremixCubeCompute {
public:
    uint64_t m_{0};
    uint64_t n_{0};
    uint64_t k_{0};
...
public:
    ...
    __aicore__ inline MhcPreSinkhornPremixCubeCompute() {}
