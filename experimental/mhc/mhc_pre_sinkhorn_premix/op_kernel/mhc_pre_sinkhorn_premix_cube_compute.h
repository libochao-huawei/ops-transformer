...
/*!
 * \file mhc_pre_sinkhorn_premix_cube_compute.h
 * \brief
 */
#ifndef MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_H
#define MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_H
...
#define MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM template <bool enableSquareSum>
#define MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS HcCubeComputeSplitK<enableSquareSum>
#define MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_TEMPLATE_PARAM template <typename T>
#define MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_TEMPLATE_CLASS HcCubeCompute<T>

// 切K使用的矩阵乘实现
MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
...
private:
    ...
    TPipe *pipe_;
    const MhcPreSinkhornPremixTilingData *tiling_;
...
MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::Init(
    const GlobalTensor<float> &xGm, const GlobalTensor<float> &phiGm, TPipe *tpipe)
{
    phiGm_ = phiGm;
...
MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::CopyInA1(
...
MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::CopyInB1(uint64_t mGmOffset,
                                                                                             uint64_t kGmOffset,
                                                                                             uint64_t kL1Size,
                                                                                             const MmParams &mmParams)
{
...
MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::CopyOut(
...
MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::Fixp(
...
MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::SetBL1Mte1ToMte2Flag()
{
...
MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::WaitBL1Mte1ToMte2Flag()
{
    WaitFlag<HardEvent::MTE1_MTE2>(B_MTE1_MTE2_EVENT + l1bLoopIdx_ % L1_BUF_NUM);
}

MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::ComputeDecode(
...
MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::End()
{
    for (int i = 0; i < L0A_BUF_NUM; i++) {
...
MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::LoadAToL0A(uint64_t kL1Offset,
                                                                                               uint64_t kL0Size,
                                                                                               uint64_t l1LoopIdx,
                                                                                               const MmParams &mmParams)
{
...
MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::LoadAToL0B(uint64_t kL1Offset,
                                                                                               uint64_t kL0Size,
                                                                                               uint64_t l1LoopIdx,
                                                                                               const MmParams &mmParams)
{
...
MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::MmadA2(uint64_t kGmOffset,
                                                                                           uint64_t kL0Size,
                                                                                           bool isLastK,
                                                                                           const MmParams &mmParams)
{
...
MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::LoadBToL0B(uint64_t kL1Offset,
                                                                                               uint64_t kL0Size,
                                                                                               uint64_t l1LoopIdx,
                                                                                               const MmParams &mmParams)
{
...
MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_PARAM
__aicore__ inline void MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_SPLIT_K_TEMPLATE_CLASS::MmadAB(uint64_t kGmOffset,
                                                                                           uint64_t kL0Size,
                                                                                           bool isLastK,
                                                                                           const MmParams &mmParams)
{
...
// 不切K使用的矩阵乘实现
MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_TEMPLATE_PARAM
class HcCubeCompute {
public:
...
MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_TEMPLATE_PARAM
__aicore__ inline void MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_TEMPLATE_CLASS::Init(
    const GlobalTensor<float> &xGm, const GlobalTensor<float> &phiGm, const GlobalTensor<float> &workspaceGlobalAB,
...
MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_TEMPLATE_PARAM
__aicore__ inline void MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_TEMPLATE_CLASS::ProcessMatmulXPhi(const int32_t taskOffset,
                                                                                              const int32_t mm1M)
{
    if (mm1M <= 0)
        return;
...
#endif // MHC_PRE_SINKHORN_PREMIX_CUBE_COMPUTE_H
