...
#include <vector>
#include <cstdint>
#include "../../../../attention/common/op_host/fia_tiling_base.h"
#include "../../../../attention/common/op_host/fia_tiling_shape.h"
...
const std::string REL_H_NAME = "rel_h";
const std::string REL_W_NAME = "rel_w";
...
constexpr uint32_t REL_H_INDEX = 3;
constexpr uint32_t REL_W_INDEX = 4;
constexpr uint32_t BLOCK_TABLE_INDEX = 5;
constexpr uint32_t CU_SEQLENS_Q_INDEX = 6;
constexpr uint32_t CU_SEQLENS_KV_INDEX = 7;
constexpr uint32_t SEQUSED_Q_INDEX = 8;
constexpr uint32_t SEQUSED_KV_INDEX = 9;
constexpr uint32_t SINKS_INDEX = 10;
constexpr uint32_t ATTN_MASK_INDEX = 11;
...
struct FAParaInfo {
    ...
    FAOptionalParaInfo relH = {nullptr, nullptr};
    FAOptionalParaInfo relW = {nullptr, nullptr};
...
const std::map<std::string, std::vector<ge::DataType>> DTYPE_SUPPORT_MAP = {
    ...
    {VALUE_NAME, {ge::DT_FLOAT16, ge::DT_BF16}}, {REL_H_NAME, {ge::DT_FLOAT16, ge::DT_BF16}},
    {REL_W_NAME, {ge::DT_FLOAT16, ge::DT_BF16}}, {ATTN_MASK_NAME, {ge::DT_INT8}},
