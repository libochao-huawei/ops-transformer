...
public:
    ...
    __gm__ const BlockSparseAttentionGradTilingData *__restrict tilingData;
    SoftMaxTiling softmaxGradTilingData;

    __aicore__ inline SoftmaxGrad(Params const &params)
    {
        cBlockIdx = GetBlockIdx();
        tilingData = reinterpret_cast<__gm__ BlockSparseAttentionGradTilingData *>(params.tilingData);
        softmaxGradTilingData.srcM = tilingData->softmaxGradTilingData.srcM;
        softmaxGradTilingData.srcK = tilingData->softmaxGradTilingData.srcK;
        softmaxGradTilingData.srcSize = tilingData->softmaxGradTilingData.srcSize;
        softmaxGradTilingData.outMaxM = tilingData->softmaxGradTilingData.outMaxM;
        softmaxGradTilingData.outMaxK = tilingData->softmaxGradTilingData.outMaxK;
        softmaxGradTilingData.outMaxSize = tilingData->softmaxGradTilingData.outMaxSize;
        softmaxGradTilingData.splitM = tilingData->softmaxGradTilingData.splitM;
        softmaxGradTilingData.splitK = tilingData->softmaxGradTilingData.splitK;
        softmaxGradTilingData.splitSize = tilingData->softmaxGradTilingData.splitSize;
        softmaxGradTilingData.reduceM = tilingData->softmaxGradTilingData.reduceM;
        softmaxGradTilingData.reduceK = tilingData->softmaxGradTilingData.reduceK;
        softmaxGradTilingData.reduceSize = tilingData->softmaxGradTilingData.reduceSize;
        softmaxGradTilingData.rangeM = tilingData->softmaxGradTilingData.rangeM;
        softmaxGradTilingData.tailM = tilingData->softmaxGradTilingData.tailM;
        softmaxGradTilingData.tailSplitSize = tilingData->softmaxGradTilingData.tailSplitSize;
        softmaxGradTilingData.tailReduceSize = tilingData->softmaxGradTilingData.tailReduceSize;
    ...
    // startIdx addresses flattened BNS rows for BNSD or TN rows for TND.
    // singleCoreRowCount is the number of query rows assigned to this core.
    template <>
        ...
        for (uint64_t i = 0; i < singleCoreLoop; i++) {
            ...
            if (likely(isBasicBlock)) {
                SoftmaxGradFront<float, true>(softmaxGradTensor[ping], doutFp32Tensor[ping], outFp32Tensor[ping],
                                              tempBuffer, softmaxGradTilingData);
            } else {
    ...
    // seqS contains per-batch sequence lengths; curS receives the selected length.
