...
__attribute__((visibility("default"))) aclnnStatus aclnnQuantLightningIndexerV2MetadataGetWorkspaceSize(
...
__attribute__((visibility("default"))) aclnnStatus aclnnQuantLightningIndexerV2Metadata(void *workspace,
