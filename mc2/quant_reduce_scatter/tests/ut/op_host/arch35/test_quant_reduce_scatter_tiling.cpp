...
static QuantReduceScatterTestParam g_testCases[] = {
    {"quant_reduce_scatter_critical_case_1",
     ...
     ge::GRAPH_SUCCESS,
     0UL,
     "1024 5120 80 64 314572800 4398046514176 314572800 2 ",
     {16777216},
     0},
    {"quant_reduce_scatter_critical_case_2",
     ...
     ge::GRAPH_SUCCESS,
     0UL,
     "2048 5120 40 64 314572800 4398046517248 314572800 1 ",
     {16777216},
     0},
    {"quant_reduce_scatter_critical_case_3",
     ...
     ge::GRAPH_SUCCESS,
     0UL,
     "1024 7168 56 64 314572800 4398046515200 314572800 1 ",
     {16777216},
     0},
    {"quant_reduce_scatter_critical_case_1_x3d",
     ...
     ge::GRAPH_SUCCESS,
     0UL,
     "1024 4096 64 64 314572800 4398046513152 314572800 2 ",
     {16777216},
     0},
    {"quant_reduce_scatter_critical_case_2_x3d",
     ...
     ge::GRAPH_SUCCESS,
     0UL,
     "2048 4096 32 64 314572800 4398046516224 314572800 1 ",
     {16777216},
     0},
    {"quant_reduce_scatter_critical_case_3_x3d",
     ...
     ge::GRAPH_SUCCESS,
     0UL,
     "1024 8192 64 64 314572800 4398046516224 314572800 1 ",
     {16777216},
     0},
    ...
    {"quant_reduce_scatter_critical_case_rank2_mx",
     ...
     ge::GRAPH_SUCCESS,
     0UL,
     "1024 5120 80 64 314572800 4398046524416 314572800 2 ",
     {16777216},
     0},
    {"quant_reduce_scatter_critical_case_rank4_tg",
     ...
     ge::GRAPH_SUCCESS,
     0UL,
     "1024 5120 40 64 314572800 4398046517248 314572800 1 ",
     {16777216},
     0},
    {"quant_reduce_scatter_critical_case_H1024_tg",
     ...
     ge::GRAPH_SUCCESS,
     0UL,
     "1024 1024 8 64 314572800 4398046513152 314572800 1 ",
     {16777216},
     0},
    {"quant_reduce_scatter_critical_case_H8192_mx",
     ...
     ge::GRAPH_SUCCESS,
     0UL,
     "1024 8192 128 64 314572800 4398046516224 314572800 2 ",
     {16777216},
     0},
    ...
    {"quant_reduce_scatter_critical_case_3d_tg_int8_float_out",
     ...
     ge::GRAPH_SUCCESS,
     0UL,
     "1024 5120 40 64 314572800 4398046514176 314572800 1 ",
     {16777216},
     0},
    ...
    {"quant_reduce_scatter_critical_case_3d_tg_rank2",
     ...
     ge::GRAPH_SUCCESS,
     0UL,
     "1024 5120 40 64 314572800 4398046524416 314572800 1 ",
     {16777216},
     0},
    // --- 新增 pertensor(PT) 量化用例 ---
    {"quant_reduce_scatter_critical_case_pt_int8_2d",
     {1024, 5120},
     ge::DT_INT8,
     ge::FORMAT_ND,
     {1},
     ...
     ge::GRAPH_SUCCESS,
     0UL,
     "1024 5120 1 64 314572800 4398046514176 314572800 3 ",
     {16777216},
     0},
    {"quant_reduce_scatter_critical_case_pt_hifloat8_2d",
     {1024, 5120},
     ge::DT_HIFLOAT8,
     ge::FORMAT_ND,
     {1},
     ...
     {16777216},
     0},
    {"quant_reduce_scatter_critical_case_pt_fp8e4m3_2d",
     {1024, 5120},
     ge::DT_FLOAT8_E4M3FN,
     ge::FORMAT_ND,
     {1},
     ...
     {16777216},
     0},
    {"quant_reduce_scatter_critical_case_pt_int8_3d",
     {2, 512, 5120},
     ge::DT_INT8,
     ge::FORMAT_ND,
     {1},
     ...
     ge::GRAPH_SUCCESS,
     0UL,
     "1024 5120 1 64 314572800 4398046524416 314572800 3 ",
     {16777216},
     0},
    // --- 新增异常路径用例 ---
    ...
    {"quant_reduce_scatter_abuse_case_3d_output_h_wrong",
     ...
     {},
     0},
    {"quant_reduce_scatter_abuse_case_invalid_reduce_op",
     {1024, 5120},
     ge::DT_INT8,
     ge::FORMAT_ND,
     {1024, 40},
    ...
    {"quant_reduce_scatter_abuse_case_quant_mode_mismatch",
     ...
     {},
     0},
    {"quant_reduce_scatter_abuse_case_pt_scales_shape_wrong",
     {1024, 5120},
     ge::DT_INT8,
     ge::FORMAT_ND,
     {2},
     ...
     {},
     0},
    {"quant_reduce_scatter_abuse_case_pt_scales_dtype_wrong",
     {1024, 5120},
     ge::DT_INT8,
     ge::FORMAT_ND,
     {1},
     ...
     {},
     0},
    {"quant_reduce_scatter_abuse_case_pt_scales_2d",
     {1024, 5120},
     ge::DT_INT8,
     ge::FORMAT_ND,
     {1, 1},
     ...
     {},
     0},
    {"quant_reduce_scatter_abuse_case_pt_x_rank_not_divisible",
     {1023, 5120},
     ge::DT_INT8,
     ge::FORMAT_ND,
     {1},
