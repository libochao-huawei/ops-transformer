...
/*!
 * \file moe_distribute_dispatch_v2_apt_tiling_key.h
 * \brief A5 (arch35) tiling key selections.
 */
#ifndef MOE_DISTRIBUTE_DISPATCH_V2_APT_TILING_KEY_H
#define MOE_DISTRIBUTE_DISPATCH_V2_APT_TILING_KEY_H
...
ASCENDC_TPL_SEL(
    ...
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(TILINGKEY_QUANT_MODE, ASCENDC_TPL_UI_LIST, TILINGKEY_NO_QUANT,
                                              TILINGKEY_PERTOKEN_QUANT, TILINGKEY_PERGROUP_QUANT,
                                              TILINGKEY_MX_QUANT, TILINGKEY_MX_QUANT_CLIP),
                         ...
                         ASCENDC_TPL_UINT_SEL(TILINGKEY_COMM_MODE, ASCENDC_TPL_UI_LIST,
                                              TILINGKEY_TPL_MTE, TILINGKEY_TPL_CCU),
    ...
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(TILINGKEY_QUANT_MODE, ASCENDC_TPL_UI_LIST, TILINGKEY_NO_QUANT,
                                              TILINGKEY_STATIC_QUANT, TILINGKEY_PERTOKEN_QUANT,
                                              TILINGKEY_PERGROUP_QUANT),
