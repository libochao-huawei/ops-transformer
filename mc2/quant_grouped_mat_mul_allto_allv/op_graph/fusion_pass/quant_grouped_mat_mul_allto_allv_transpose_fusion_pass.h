...
#ifndef TRANSFORMER_QUANT_GROUPED_MAT_MUL_ALLTO_ALLV_TRANSPOSE_FUSION_PASS_H
#define TRANSFORMER_QUANT_GROUPED_MAT_MUL_ALLTO_ALLV_TRANSPOSE_FUSION_PASS_H
...
namespace ops {
class __attribute__((visibility("default"))) QuantGroupedMatMulAlltoAllvTransposeFusionPass
...
#endif // TRANSFORMER_QUANT_GROUPED_MAT_MUL_ALLTO_ALLV_TRANSPOSE_FUSION_PASS_H
