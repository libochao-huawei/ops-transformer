...
/*!
 * \file moe_distribute_combine_v2_fusion_pass.h
 * \brief MoeDistributeCombineV2 → MoeDistributeCombineV3 融合 pass
 */
#ifndef OPS_TRANSFORMER_MOE_DISTRIBUTE_COMBINE_V2_FUSION_PASS_H
#define OPS_TRANSFORMER_MOE_DISTRIBUTE_COMBINE_V2_FUSION_PASS_H
...
private:
    ge::graphStatus Fusion(ge::Graph &graph, ge::GNode &moeDistributeCombineNode, ge::GNode &sharedCtxNode);
    ge::graphStatus CreateFusionNode(ge::Graph &graph, ge::GNode &moeDistributeCombineNode,
...
#endif  // OPS_TRANSFORMER_MOE_DISTRIBUTE_COMBINE_V2_FUSION_PASS_H
