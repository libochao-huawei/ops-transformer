...
static MatmulAlltoAllV2AclnnTestParam g_v2_casesParams_a5[] = {
    ...
    // ========================bfloat16 系列（6条）========================
    // 1. Bias=BF16 (2)
    {"AclnnMatmulAlltoAllV2-bf16-biasbf16-nd-notrans-01",
     2,
     {256, 128},
     {128, 256},
     {256},
     ...
     ACL_FORMAT_ND,
     {-1, -2},
     "ut_test_matmul_allto_all",
     "ai_cpu",
     false,
     false,
     ACLNN_SUCCESS},
    {"AclnnMatmulAlltoAllV2-bf16_biasbf16_nd_trans_02",
     2,
     {256, 128},
     {256, 128},
     {256},
     ...
     ACLNN_SUCCESS},
    // 2. Bias=FLOAT32 (2)
    {"AclnnMatmulAlltoAllV2-bf16-biasf32-nd-notrans-03",
     2,
     {256, 128},
     {128, 256},
     {256},
     ...
     false,
     ACLNN_SUCCESS},
    {"AclnnMatmulAlltoAllV2-bf16-biasf32-nd-trans-04",
     2,
     {256, 128},
     {256, 128},
     {256},
     ...
     ACLNN_SUCCESS},
    // 3. Bias=Null (2)
    {"AclnnMatmulAlltoAllV2-bf16-biasnull-nd-notrans-05",
     2,
     {256, 128},
     {128, 256},
     {},
     ...
     false,
     ACLNN_SUCCESS},
    {"AclnnMatmulAlltoAllV2-bf16-biasnull-nd-trans-06",
     2,
     {256, 128},
     {256, 128},
     {},
    ...
    // ========================float16 系列（6条）========================
    // 1. Bias=FP16 (2)
    {"AclnnMatmulAlltoAllV2-fp16-biasfp16-nd-notrans-07",
     2,
     {256, 128},
     {128, 256},
     {256},
     ...
     false,
     ACLNN_SUCCESS},
    {"AclnnMatmulAlltoAllV2-fp16-biasfp16-nd-trans-08",
     2,
     {256, 128},
     {256, 128},
     {256},
     ...
     ACLNN_SUCCESS},
    // 2. Bias=FLOAT32 (2)
    {"AclnnMatmulAlltoAllV2-fp16-biasf32-nd-notrans-09",
     2,
     {256, 128},
     {128, 256},
     {256},
     ...
     false,
     ACLNN_SUCCESS},
    {"AclnnMatmulAlltoAllV2-fp16-biasf32-nd-trans-10",
     2,
     {256, 128},
     {256, 128},
     {256},
     ...
     ACLNN_SUCCESS},
    // 3. Bias=Null (2)
    {"AclnnMatmulAlltoAllV2-fp16-biasnull-nd-notrans-11",
     2,
     {256, 128},
     {128, 256},
     {},
     ...
     false,
     ACLNN_SUCCESS},
    {"AclnnMatmulAlltoAllV2-fp16-biasnull-nd-trans-12",
     2,
     {256, 128},
     {256, 128},
     {},
     ...
     ACLNN_SUCCESS},
    // 空tensor场景 1条
    {"AclnnMatmulAlltoAllV2-x1_empty_tensor",
     2,
     {0, 128},
     {128, 256},
     {256},
    ...
    {"error-AclnnMatmulAlltoAllV2-x1dtype_invalid-01",
     2,
     {256, 128},
     {128, 256},
     {256},
    ...
    {"error-AclnnMatmulAlltoAllV2-x2dtype_invalid-02",
     2,
     {256, 128},
     {128, 256},
     {256},
    ...
    {"error-AclnnMatmulAlltoAllV2-biasdtype_invalid-03",
     2,
     {256, 128},
     {128, 256},
     {256},
    ...
    {"error-AclnnMatmulAlltoAllV2-outdtype_mismatch_04",
     2,
     {256, 128},
     {128, 256},
     {256},
    ...
    // 5. 空tensor (3条)
    // 5.1 x1有维度为0
    {"error-AclnnMatmulAlltoAllV2-x1empty-05",
     2,
     {256, 0},
     {128, 256},
     {256},
    ...
    {"error-AclnnMatmulAlltoAllV2-x2empty-06",
     2,
     {256, 128},
     {0, 256},
     {256},
    ...
    {"error-AclnnMatmulAlltoAllV2-x2empty-07",
     2,
     {256, 128},
     {128, 0},
     {256},
     ...
     ACLNN_ERR_PARAM_INVALID},
    // 6. format为私有格式(4条)
    {"error-AclnnMatmulAlltoAllV2-private_fmt1-08",
     2,
     {256, 128},
     {128, 256},
     {256},
     ...
     false,
     ACLNN_ERR_PARAM_INVALID},
    {"error-AclnnMatmulAlltoAllV2-private_fmt2-09",
     2,
     {256, 128},
     {128, 256},
     {256},
     ...
     false,
     ACLNN_ERR_PARAM_INVALID},
    {"error-AclnnMatmulAlltoAllV2-private_fmt3-10",
     2,
     {256, 128},
     {128, 256},
     {256},
     ...
     false,
     ACLNN_ERR_PARAM_INVALID},
    {"error-AclnnMatmulAlltoAllV2-private_fmt4-11",
     2,
     {256, 128},
     {128, 256},
     {256},
     ...
     ACLNN_ERR_PARAM_INVALID},
    // 7. AlltoAllAxes不合法
    {"error-AclnnMatmulAlltoAllV2-invalid_axes-12",
     2,
     {256, 128},
     {128, 256},
     {256},
    ...
    // 8. group不合法 (2条)
    // 8.1 group为空
    {"error-AclnnMatmulAlltoAllV2-group_empty-13",
     2,
     {256, 128},
     {128, 256},
     {256},
    ...
    {"error-AclnnMatmulAlltoAllV2-group_extralong-14",
     2,
     {256, 128},
     {128, 256},
     {256},
     ...
     ACLNN_ERR_PARAM_INVALID},
    // 9. transposeX1=true
    {"error-AclnnMatmulAlltoAllV2-transx1-15",
     2,
     {128, 256},
     {128, 256},
     {256},
    ...
    // 10. shape不合法 (8条)
    // 10.1 x1维度不合法
    {"error-AclnnMatmulAlltoAllV2-invalid_x1dim-16",
     2,
     {256, 128, 32},
     {128, 256},
     {256},
     ...
     ACLNN_ERR_PARAM_INVALID},
    // 10.2 x2维度不合法
    {"error-AclnnMatmulAlltoAllV2-invalid_x2dim-17",
     2,
     {256, 128},
     {128, 256, 32},
     {256},
     ...
     ACLNN_ERR_PARAM_INVALID},
    // 10.3 output维度不合法
    {"error-AclnnMatmulAlltoAllV2-invalid_outputdim-18",
     2,
     {256, 128},
     {128, 256},
     {256},
     ...
     ACLNN_ERR_PARAM_INVALID},
    // 10.4 bias维度不合法
    {"error-AclnnMatmulAlltoAllV2-invalid_biasdim-19",
     2,
     {256, 128, 32},
     {128, 256},
     {256, 32},
    ...
    {"error-AclnnMatmulAlltoAllV2-mismatch_kdim-20",
     2,
     {256, 64},
     {128, 256},
     {256},
    ...
    {"error-AclnnMatmulAlltoAllV2-mismatch_kdim-21",
     2,
     {256, 128},
     {256, 64},
     {256},
     ...
     ACLNN_ERR_PARAM_INVALID},
    // 10.7 k轴超出范围
    {"error-AclnnMatmulAlltoAllV2-outrange_kdim-22",
     2,
     {256, 65536},
     {65536, 256},
     {256},
     ...
     ACLNN_ERR_PARAM_INVALID},
    // 10.8 bias和x2不匹配
    {"error-AclnnMatmulAlltoAllV2-mismatch_kdim-23",
     2,
     {256, 128},
     {128, 256},
     {128},
     ...
     ACLNN_ERR_PARAM_INVALID},
    // 11. commMode不合法（1条）
    {"error-AclnnMatmulAlltoAllV2-wrong-commMode-24",
     2,
     {256, 128},
     {128, 256},
     {256},
     ...
     false,
     ACLNN_ERR_PARAM_INVALID},
    {"error-AclnnMatmulAlltoAllV2-wrong-commMode-25",
     2,
     {256, 128},
     {128, 256},
     {256},
     ...
     false,
     ACLNN_ERR_PARAM_INVALID},
    {"error-AclnnMatmulAlltoAllV2-nullptr-commMode-26",
     2,
     {256, 128},
     {128, 256},
     {256},
...
static void TestV2OneParamCase(const MatmulAlltoAllV2AclnnTestParam &param)
{
    ...
    if (param.x1Null || param.x2Null || param.outputNull) {
        ...
        auto ut =
            OP_API_UT(aclnnMatmulAlltoAllV2,
        ...
        if (x1Ptr != nullptr)
            aclDestroyTensor(x1Ptr);
        if (x2Ptr != nullptr)
            aclDestroyTensor(x2Ptr);
        if (outputPtr != nullptr)
            aclDestroyTensor(outputPtr);
        if (biasPtr != nullptr)
            aclDestroyTensor(biasPtr);
    } else {
...
static MatmulAlltoAllV2AclnnTestParam g_v2_casesParams_910B[] = {
    // ========================910B 正常用例 ========================
    // BF16 + bias=FLOAT32
    {"AclnnMatmulAlltoAllV2-910B-bf16-biasf32-nd-notrans-01",
     2,
     {256, 128},
     {128, 256},
     {256},
     ...
     false,
     ACLNN_SUCCESS},
    {"AclnnMatmulAlltoAllV2-910B-bf16-biasf32-nd-trans-02",
     2,
     {256, 128},
     {256, 128},
     {256},
     ...
     ACLNN_SUCCESS},
    // BF16 + bias=Null
    {"AclnnMatmulAlltoAllV2-910B-bf16-biasnull-nd-notrans-03",
     2,
     {256, 128},
     {128, 256},
     {},
     ...
     ACLNN_SUCCESS},
    // FP16 + bias=FP16
    {"AclnnMatmulAlltoAllV2-910B-fp16-biasfp16-nd-notrans-04",
     2,
     {256, 128},
     {128, 256},
     {256},
     ...
     ACLNN_SUCCESS},
    // FP16 + bias=Null
    {"AclnnMatmulAlltoAllV2-910B-fp16-biasnull-nd-notrans-06",
     2,
     {256, 128},
     {128, 256},
     {},
    ...
    {"error-AclnnMatmulAlltoAllV2-910B-bf16-biasbf16-07",
     2,
     {256, 128},
     {128, 256},
     {256},
     ...
     ACLNN_ERR_PARAM_INVALID},
    // FP16 + bias=FLOAT32
    {"AclnnMatmulAlltoAllV2-910B-fp16-biasf32-nd-notrans-05",
     2,
     {256, 128},
     {128, 256},
     {256},
    ...
    {"error-AclnnMatmulAlltoAllV2-910B-x1_m_zero-08",
     2,
     {0, 128},
     {128, 256},
     {256},
     ...
     ACLNN_ERR_PARAM_INVALID},
    // x1 dtype不合法
    {"error-AclnnMatmulAlltoAllV2-910B-x1dtype_invalid-09",
     2,
     {256, 128},
     {128, 256},
     {256},
     ...
     ACLNN_ERR_PARAM_INVALID},
    // format为私有格式
    {"error-AclnnMatmulAlltoAllV2-910B-private_fmt-10",
     2,
     {256, 128},
     {128, 256},
     {256},
    ...
    // ========================ReFormatNotND 覆盖（2条）========================
    {"AclnnMatmulAlltoAllV2-910B-reformat_x1_fractal_nz-14",
     2,
     {256, 128},
     {128, 256},
     {256},
     ...
     false,
     ACLNN_ERR_PARAM_INVALID},
    {"AclnnMatmulAlltoAllV2-910B-reformat_x2_fractal_nz-15",
     2,
     {256, 128},
     {128, 256},
     {256},
    ...
    // ========================commMode 覆盖（2条）========================
    {"AclnnMatmulAlltoAllV2-910B-nullptr-commMode-16",
     2,
     {256, 128},
     {128, 256},
     {256},
