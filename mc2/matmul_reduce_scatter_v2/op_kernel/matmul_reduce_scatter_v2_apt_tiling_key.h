...
// TPL_COMM_MODE uint8_t
#define TPL_CCU_COMM_MODE 0
#define TPL_AICPU_COMM_MODE 1
...
ASCENDC_TPL_ARGS_DECL(
    ...
    ASCENDC_TPL_UINT_DECL(TPL_INPUT, ASCENDC_TPL_2_BW, ASCENDC_TPL_UI_LIST, \
                        INPUT_TYPE_IS_FP8, INPUT_TYPE_IS_FP16_BF16, INPUT_TYPE_IS_FP4),
    ...
    ASCENDC_TPL_UINT_DECL(TPL_COMM_MODE, ASCENDC_TPL_1_BW, ASCENDC_TPL_UI_LIST, \
                        TPL_CCU_COMM_MODE, TPL_AICPU_COMM_MODE),
);
...
ASCENDC_TPL_SEL(
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_UINT_SEL(TPL_COMMALG, ASCENDC_TPL_UI_LIST, \
                             TPL_CCU_REDUCESUM, TPL_CCU_ALL2ALL_VEC_REDUCE),
        ASCENDC_TPL_UINT_SEL(TPL_COMM_MODE, ASCENDC_TPL_UI_LIST, \
                             TPL_CCU_COMM_MODE, TPL_AICPU_COMM_MODE),
    ),
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_BOOL_SEL(TPL_TRANSA, 0),
        ASCENDC_TPL_BOOL_SEL(TPL_TRANSB, 0, 1),
        ASCENDC_TPL_UINT_SEL(TPL_INPUT, ASCENDC_TPL_UI_LIST, INPUT_TYPE_IS_FP8, INPUT_TYPE_IS_FP4),
        ASCENDC_TPL_UINT_SEL(TPL_OUTPUTDTYPE, ASCENDC_TPL_UI_LIST, OUTPUT_TYPE_IS_FP16_BF16, \
                            OUTPUT_TYPE_IS_FLOAT),
