...
#ifndef TRANSFORMER_MATMUL_REDUCE_SCATTER_V2_TRANSPOSE_A5_FUSION_PASS_H
#define TRANSFORMER_MATMUL_REDUCE_SCATTER_V2_TRANSPOSE_A5_FUSION_PASS_H
...
namespace ops {
class __attribute__((visibility("default"))) MatmulReduceScatterV2TransposeA5FusionPass
...
#endif // TRANSFORMER_MATMUL_REDUCE_SCATTER_V2_TRANSPOSE_A5_FUSION_PASS_H
