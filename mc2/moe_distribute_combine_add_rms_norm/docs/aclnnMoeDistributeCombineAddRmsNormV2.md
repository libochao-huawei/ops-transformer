...
- **参数说明**
    ...
    <td>输入</td>
    <td>TP通信域名称（数据并行）。</td>
    <td>字符串长度[1, 128)，不可与groupEp相同。</td>
    <td>STRING</td>
    <td>-</td>
    <td>-</td>
    <td>-</td>
    ...
    <td>输入</td>
    <td>TP通信域大小。</td>
    <td>取值范围[0, 2]，0/1表示无TP域通信，有TP域通信时仅支持2。</td>
    <td>INT64</td>
    <td>-</td>
    <td>-</td>
    <td>-</td>
    ...
    <td>输入</td>
    <td>TP域本卡ID。</td>
    <td>取值范围[0, 1]，同一通信域内不重复；无TP域通信时传0。</td>
    <td>INT64</td>
    <td>-</td>
    <td>-</td>
    <td>-</td>
...
- 其他约束：
    ...
    - <term>Atlas A3 训练系列产品/Atlas A3 推理系列产品</term>、<term>Ascend 950PR/Ascend 950DT</term>：暂不支持动态缩容。
