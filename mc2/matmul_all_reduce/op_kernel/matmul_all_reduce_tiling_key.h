...
#define TPL_PARAMS_WEIGHT_QUANT_MM                                                                                     \
    int SUB_ALGORITHM_CUSTOM, bool HAS_ANTIQUANT_OFFSET, int ANTIQUANT_TYPE, bool TRANS_A, bool TRANS_B, bool FORMAT_B
#define PARAMS_WEIGHT_QUANT_MM SUB_ALGORITHM_CUSTOM, HAS_ANTIQUANT_OFFSET, ANTIQUANT_TYPE, TRANS_A, TRANS_B, FORMAT_B
...
ASCENDC_TPL_ARGS_DECL(
    ...
    // MM_TYPE
    ASCENDC_TPL_UINT_DECL(MM_TYPE, ASCENDC_TPL_2_BW, ASCENDC_TPL_UI_LIST, MATMUL_ALLREDUCE_MM_TYPE_FP_MM,
                          MATMUL_ALLREDUCE_MM_TYPE_FP_MM_CUBE_ONLY, MATMUL_ALLREDUCE_MM_TYPE_QUANT_MATMUL,
    ...
    // TPL_PARAMS_FP_MM
    ASCENDC_TPL_UINT_DECL(MIXND2NZ, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, MAT_MUL_V3_MIXND2NZ_TRUE,
                          MAT_MUL_V3_MIXND2NZ_FALSE, MAT_MUL_V3_MIXND2NZ_TRUE_PARALLEL),

    // quant_batch_matmul_v3
    ASCENDC_TPL_UINT_DECL(TRANS, ASCENDC_TPL_2_BW, ASCENDC_TPL_UI_LIST, QUANT_BATCH_MATMUL_V3_NOT_TRANS,
                          QUANT_BATCH_MATMUL_V3_B_TRANS, QUANT_BATCH_MATMUL_V3_A_TRANS,
                          QUANT_BATCH_MATMUL_V3_ALL_TRANS),
    ASCENDC_TPL_UINT_DECL(PERTOKEN, ASCENDC_TPL_2_BW, ASCENDC_TPL_UI_LIST, QUANT_BATCH_MATMUl_V3_NOT_PERTOKEN,
                          QUANT_BATCH_MATMUl_V3_IS_PERTOKEN),

    // weight_quant_batch_matmul_v2
    ASCENDC_TPL_UINT_DECL( // 算法小类-传统CUSTOM
        SUB_ALGORITHM_CUSTOM, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, WQBMMV2_SUB_ALGO_SERIAL,
        WQBMMV2_SUB_ALGO_GENERAL_PARALLEL, WQBMMV2_SUB_ALGO_SPLIT_K_CUSTOM, WQBMMV2_SUB_ALGO_CUSTOM_ANTIQUANT,
        PLACEHOLDER_4, PLACEHOLDER_5, WQBMMV2_SUB_ALGO_MSD_MULTI_CORE, WQBMMV2_SUB_ALGO_MSD_GROUP,
        WQBMMV2_SUB_ALGO_WEIGHT_NZ, WQBMMV2_SUB_ALGO_MIX_SPLIT_K, WQBMMV2_SUB_ALGO_ANTI_REG),
    ASCENDC_TPL_BOOL_DECL( // 可选输入
        HAS_ANTIQUANT_OFFSET, 0, 1),
    ASCENDC_TPL_UINT_DECL( // 反量化类型
        ANTIQUANT_TYPE, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST, WQBMMV2_ANTIQUANT_TYPE_NONE,
        WQBMMV2_ANTIQUANT_TYPE_PER_TENSOR, WQBMMV2_ANTIQUANT_TYPE_PER_CHANNEL, WQBMMV2_ANTIQUANT_TYPE_PER_GROUP,
...
#define SET_NOT_USE_FP_MM_TPL_SEL ASCENDC_TPL_UINT_SEL(MIXND2NZ, ASCENDC_TPL_UI_LIST, 0)

#define SET_NOT_USE_QUANT_MM_TPL_SEL                                                                                   \
    ASCENDC_TPL_UINT_SEL(TRANS, ASCENDC_TPL_UI_LIST, 0), ASCENDC_TPL_UINT_SEL(PERTOKEN, ASCENDC_TPL_UI_LIST, 0)

#define SET_NOT_USE_WEIGHT_QUANT_MM_TPL_SEL                                                                            \
    ASCENDC_TPL_UINT_SEL(SUB_ALGORITHM_CUSTOM, ASCENDC_TPL_UI_LIST, 0), ASCENDC_TPL_BOOL_SEL(HAS_ANTIQUANT_OFFSET, 0), \
        ASCENDC_TPL_UINT_SEL(ANTIQUANT_TYPE, ASCENDC_TPL_UI_LIST, 0), ASCENDC_TPL_BOOL_SEL(TRANS_A, 0),                \
        ASCENDC_TPL_BOOL_SEL(TRANS_B, 0), ASCENDC_TPL_BOOL_SEL(FORMAT_B, 0)
...
ASCENDC_TPL_SEL(
    ...
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_UINT_SEL(AICORE_TYPE, ASCENDC_TPL_UI_LIST, ASCEND_310P),
        ...
        ASCENDC_TPL_BOOL_SEL(INT8_COMM, MATMUL_ALLREDUCE_INT8_COMM_F), ASCENDC_TPL_BOOL_SEL(ENABLE_L2_CACHE, 0),
        ASCENDC_TPL_BOOL_SEL(SHARE_MM, 0), SET_NOT_USE_FP_MM_TPL_SEL, SET_NOT_USE_QUANT_MM_TPL_SEL,
        SET_NOT_USE_WEIGHT_QUANT_MM_TPL_SEL,
        ASCENDC_TPL_TILING_STRUCT_SEL(Mc2Tiling::QuantMatmulAllReduceTilingData)), // tiling_key num = 1
                                                                                   // 310P weightQuant
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_BOOL_SEL(TRANS_A, 0, 1), ASCENDC_TPL_BOOL_SEL(TRANS_B, 0),
        ASCENDC_TPL_BOOL_SEL(FORMAT_B, FORMAT_B_NZ),
        ASCENDC_TPL_TILING_STRUCT_SEL(Mc2Tiling::WeightQuantMatmulAllReduceTilingData)), // tiling_key num = 8
                                                                                         // 310P unquant
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_BOOL_SEL(TRANS_A, 0), ASCENDC_TPL_BOOL_SEL(TRANS_B, 0), ASCENDC_TPL_BOOL_SEL(FORMAT_B, FORMAT_B_NZ),
        ASCENDC_TPL_TILING_STRUCT_SEL(Mc2Tiling::UnQuantMatmulAllReduceTilingData)), // tiling_key num = 2
                                                                                     // 310P genreal
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(AICORE_TYPE, ASCENDC_TPL_UI_LIST, ASCEND_310P),
                         ASCENDC_TPL_UINT_SEL(MM_TYPE, ASCENDC_TPL_UI_LIST, MATMUL_ALLREDUCE_MM_TYPE_FP_MM,
                                              MATMUL_ALLREDUCE_MM_TYPE_WEIGHT_QUANT_MATMUL),
                         ASCENDC_TPL_BOOL_SEL(EMPTY_INPUT, MATMUL_ALLREDUCE_EMPTY_INPUT_F),
                         ASCENDC_TPL_BOOL_SEL(INT8_COMM, MATMUL_ALLREDUCE_INT8_COMM_F),
                         ASCENDC_TPL_BOOL_SEL(ENABLE_L2_CACHE, 0, 1), ASCENDC_TPL_BOOL_SEL(SHARE_MM, 0),
                         SET_NOT_USE_FP_MM_TPL_SEL, SET_NOT_USE_QUANT_MM_TPL_SEL,
                         ASCENDC_TPL_UINT_SEL(SUB_ALGORITHM_CUSTOM, ASCENDC_TPL_UI_LIST, SET_NOT_USE_PARAM),
                         ASCENDC_TPL_BOOL_SEL(HAS_ANTIQUANT_OFFSET, 0, 1),
                         ASCENDC_TPL_UINT_SEL(ANTIQUANT_TYPE, ASCENDC_TPL_UI_LIST, WQBMMV2_ANTIQUANT_TYPE_NONE,
                                              WQBMMV2_ANTIQUANT_TYPE_PER_TENSOR, WQBMMV2_ANTIQUANT_TYPE_PER_CHANNEL),
                         ASCENDC_TPL_BOOL_SEL(TRANS_A, 1), ASCENDC_TPL_BOOL_SEL(TRANS_B, 0, 1),
                         ASCENDC_TPL_BOOL_SEL(FORMAT_B, FORMAT_B_ND),
                         ASCENDC_TPL_TILING_STRUCT_SEL(Mc2Tiling::MatmulAllReduceTilingData)),
    ...
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(AICORE_TYPE, ASCENDC_TPL_UI_LIST, ASCEND_310P),
                         ...
                         ASCENDC_TPL_BOOL_SEL(INT8_COMM, MATMUL_ALLREDUCE_INT8_COMM_F),
                         ASCENDC_TPL_BOOL_SEL(ENABLE_L2_CACHE, 0), ASCENDC_TPL_BOOL_SEL(SHARE_MM, 0),
                         SET_NOT_USE_FP_MM_TPL_SEL, SET_NOT_USE_QUANT_MM_TPL_SEL,
                         ASCENDC_TPL_UINT_SEL(SUB_ALGORITHM_CUSTOM, ASCENDC_TPL_UI_LIST, SET_NOT_USE_PARAM),
                         ASCENDC_TPL_BOOL_SEL(HAS_ANTIQUANT_OFFSET, 0),
                         ASCENDC_TPL_UINT_SEL(ANTIQUANT_TYPE, ASCENDC_TPL_UI_LIST, WQBMMV2_ANTIQUANT_TYPE_NONE),
                         ASCENDC_TPL_BOOL_SEL(TRANS_A, 0), ASCENDC_TPL_BOOL_SEL(TRANS_B, 0),
                         ASCENDC_TPL_BOOL_SEL(FORMAT_B, FORMAT_B_NZ),
                         ASCENDC_TPL_TILING_STRUCT_SEL(Mc2Tiling::MatmulAllReduceTilingData)), // tiling_key num = 1
    ...
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_UINT_SEL(AICORE_TYPE, ASCENDC_TPL_UI_LIST, ASCEND_310P),
                         ...
                         ASCENDC_TPL_BOOL_SEL(INT8_COMM, MATMUL_ALLREDUCE_INT8_COMM_F),
                         ASCENDC_TPL_BOOL_SEL(ENABLE_L2_CACHE, 0), ASCENDC_TPL_BOOL_SEL(SHARE_MM, 0),
                         SET_NOT_USE_FP_MM_TPL_SEL, SET_NOT_USE_QUANT_MM_TPL_SEL, SET_NOT_USE_WEIGHT_QUANT_MM_TPL_SEL,
                         ASCENDC_TPL_TILING_STRUCT_SEL(Mc2Tiling::MatmulAllReduceTilingData)), // tiling_key num = 1
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_BOOL_SEL(TRANS_A, 0, 1), ASCENDC_TPL_BOOL_SEL(TRANS_B, 0),
        ASCENDC_TPL_BOOL_SEL(FORMAT_B, FORMAT_B_NZ),
        ASCENDC_TPL_TILING_STRUCT_SEL(Mc2Tiling::WeightQuantMatmulAllReduceNzTilingData)), // tiling_key num = 8
                                                                                           // 310P unquant
    // results: [134217729, 134217985]
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIC_1_2),
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_UINT_SEL(ANTIQUANT_TYPE, ASCENDC_TPL_UI_LIST, WQBMMV2_ANTIQUANT_TYPE_NONE),
        ASCENDC_TPL_BOOL_SEL(TRANS_A, 0), ASCENDC_TPL_BOOL_SEL(TRANS_B, 0), ASCENDC_TPL_BOOL_SEL(FORMAT_B, FORMAT_B_NZ),
        ASCENDC_TPL_TILING_STRUCT_SEL(Mc2Tiling::UnQuantMatmulAllReduceTilingData)), // tiling_key num = 1
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_UINT_SEL(ANTIQUANT_TYPE, ASCENDC_TPL_UI_LIST, WQBMMV2_ANTIQUANT_TYPE_NONE),
        ASCENDC_TPL_BOOL_SEL(TRANS_A, 0), ASCENDC_TPL_BOOL_SEL(TRANS_B, 0), ASCENDC_TPL_BOOL_SEL(FORMAT_B, FORMAT_B_NZ),
        ASCENDC_TPL_TILING_STRUCT_SEL(Mc2Tiling::WeightQuantMatmulAllReduceNzTilingData)), // tiling_key num = 1

    // empty_tensor MM/WQBMM
    // tiling_key num = 1
    // 16
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIV_1_0),
                         ASCENDC_TPL_UINT_SEL(AICORE_TYPE, ASCENDC_TPL_UI_LIST, ASCEND_910B),
                         ASCENDC_TPL_UINT_SEL(MM_TYPE, ASCENDC_TPL_UI_LIST, MATMUL_ALLREDUCE_MM_TYPE_FP_MM),
                         ASCENDC_TPL_BOOL_SEL(EMPTY_INPUT, MATMUL_ALLREDUCE_EMPTY_INPUT_T),
                         ASCENDC_TPL_BOOL_SEL(INT8_COMM, MATMUL_ALLREDUCE_INT8_COMM_F),
                         ASCENDC_TPL_BOOL_SEL(ENABLE_L2_CACHE, 0), ASCENDC_TPL_BOOL_SEL(SHARE_MM, 0),
                         SET_NOT_USE_FP_MM_TPL_SEL, SET_NOT_USE_QUANT_MM_TPL_SEL, SET_NOT_USE_WEIGHT_QUANT_MM_TPL_SEL,
                         ASCENDC_TPL_TILING_STRUCT_SEL(Mc2Tiling::MatmulAllReduce910TilingData)),
    ...
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIV_1_0),
                         ...
                         ASCENDC_TPL_BOOL_SEL(ENABLE_L2_CACHE, 0), ASCENDC_TPL_BOOL_SEL(SHARE_MM, 0),
                         SET_NOT_USE_FP_MM_TPL_SEL, SET_NOT_USE_QUANT_MM_TPL_SEL, SET_NOT_USE_WEIGHT_QUANT_MM_TPL_SEL,
                         ASCENDC_TPL_TILING_STRUCT_SEL(Mc2Tiling::WeightQuantMatmulAllReduceTilingData)),

    // MATMUL_ALLREDUCE_MM_TYPE_FP_MM
    // tiling_key num = 1
    // 260
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIC_1_0),
                         ASCENDC_TPL_UINT_SEL(AICORE_TYPE, ASCENDC_TPL_UI_LIST, ASCEND_910B),
                         ...
                         SET_NOT_USE_QUANT_MM_TPL_SEL, SET_NOT_USE_WEIGHT_QUANT_MM_TPL_SEL,
                         ASCENDC_TPL_TILING_STRUCT_SEL(Mc2Tiling::MatmulAllReduce910TilingData)),
...
// 4104(1), 20488, 8(0), 16392, 4136, 20520, 40, 16424
    ...
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIC_1_1),
                         ...
                         ASCENDC_TPL_UINT_SEL(PERTOKEN, ASCENDC_TPL_UI_LIST, QUANT_BATCH_MATMUl_V3_NOT_PERTOKEN,
                                              QUANT_BATCH_MATMUl_V3_IS_PERTOKEN),
                         SET_NOT_USE_WEIGHT_QUANT_MM_TPL_SEL,
                         ASCENDC_TPL_TILING_STRUCT_SEL(Mc2Tiling::QuantMatmulAllReduceTilingData)),

    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIC_1_2),
                         ASCENDC_TPL_UINT_SEL(AICORE_TYPE, ASCENDC_TPL_UI_LIST, ASCEND_910B),
                         ASCENDC_TPL_UINT_SEL(MM_TYPE, ASCENDC_TPL_UI_LIST, MATMUL_ALLREDUCE_MM_TYPE_QUANT_MATMUL),
                         ASCENDC_TPL_BOOL_SEL(EMPTY_INPUT, MATMUL_ALLREDUCE_EMPTY_INPUT_F),
                         ASCENDC_TPL_BOOL_SEL(INT8_COMM, MATMUL_ALLREDUCE_INT8_COMM_T),
                         ASCENDC_TPL_BOOL_SEL(ENABLE_L2_CACHE, 0), ASCENDC_TPL_BOOL_SEL(SHARE_MM, 0),
                         SET_NOT_USE_FP_MM_TPL_SEL,
                         ASCENDC_TPL_UINT_SEL(TRANS, ASCENDC_TPL_UI_LIST, QUANT_BATCH_MATMUL_V3_B_TRANS,
                                              QUANT_BATCH_MATMUL_V3_NOT_TRANS),
    ...
    ASCENDC_TPL_ARGS_SEL(ASCENDC_TPL_KERNEL_TYPE_SEL(ASCENDC_TPL_MIX_AIC_1_2),
                         ...
                         ASCENDC_TPL_UINT_SEL(MM_TYPE, ASCENDC_TPL_UI_LIST, MATMUL_ALLREDUCE_MM_TYPE_QUANT_MATMUL),
                         ASCENDC_TPL_BOOL_SEL(EMPTY_INPUT, MATMUL_ALLREDUCE_EMPTY_INPUT_F),
                         ASCENDC_TPL_BOOL_SEL(INT8_COMM, MATMUL_ALLREDUCE_INT8_COMM_F, MATMUL_ALLREDUCE_INT8_COMM_T),
                         ASCENDC_TPL_BOOL_SEL(ENABLE_L2_CACHE, 0), ASCENDC_TPL_BOOL_SEL(SHARE_MM, 0),
                         SET_NOT_USE_FP_MM_TPL_SEL,
                         ASCENDC_TPL_UINT_SEL(TRANS, ASCENDC_TPL_UI_LIST, QUANT_BATCH_MATMUL_V3_B_TRANS,
                                              QUANT_BATCH_MATMUL_V3_NOT_TRANS),
    ...
    ASCENDC_TPL_ARGS_SEL(
        ...
        ASCENDC_TPL_BOOL_SEL(TRANS_A, 0), ASCENDC_TPL_BOOL_SEL(TRANS_B, 0, 1),
        ASCENDC_TPL_BOOL_SEL(FORMAT_B, FORMAT_B_ND),
        ASCENDC_TPL_TILING_STRUCT_SEL(Mc2Tiling::WeightQuantMatmulAllReduceTilingData)),
    // tiling_key num = 4
