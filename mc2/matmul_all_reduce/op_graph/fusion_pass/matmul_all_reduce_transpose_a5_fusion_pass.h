...
#ifndef TRANSFORMER_MATMUL_ALL_REDUCE_TRANSPOSE_A5_FUSION_PASS_H
#define TRANSFORMER_MATMUL_ALL_REDUCE_TRANSPOSE_A5_FUSION_PASS_H
...
namespace ops {
class __attribute__((visibility("default"))) MatmulAllReduceTransposeA5FusionPass
...
#endif // TRANSFORMER_MATMUL_ALL_REDUCE_TRANSPOSE_A5_FUSION_PASS_H
