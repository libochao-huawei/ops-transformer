...
#ifndef TRANSFORMER_ALL_TO_ALLV_QUANT_GROUPED_MATMUL_TRANSPOSE_FUSION_PASS_H
#define TRANSFORMER_ALL_TO_ALLV_QUANT_GROUPED_MATMUL_TRANSPOSE_FUSION_PASS_H
...
namespace ops {
class __attribute__((visibility("default"))) AlltoAllvQuantGroupedMatMulTransposeFusionPass
...
#endif // TRANSFORMER_ALL_TO_ALLV_QUANT_GROUPED_MATMUL_TRANSPOSE_FUSION_PASS_H
