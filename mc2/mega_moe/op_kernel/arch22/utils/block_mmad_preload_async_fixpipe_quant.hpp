...
/*!
 * \file block_mmad_preload_async_fixpipe_quant.hpp
 * \brief
 */
...
public:
    ...
    using CopyL1ToFP =
        typename Gemm::Tile::QuantTileCopy<ArchTag, AType_, BType_, CType_, void,
                                           Catlass::Gemm::Tile::ScaleGranularity::PER_CHANNEL>::CopyL1ToFP;
