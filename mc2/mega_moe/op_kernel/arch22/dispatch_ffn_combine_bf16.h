...
#include "dispatch_ffn_combine_bf16_kernel_a2.hpp"
...
template <TemplateMMA2AClass>
__aicore__ inline void DispatchFFNCombineBF16<TemplateMMA2ACFunc>::Init(
    GM_ADDR xGM, GM_ADDR weight1GM, GM_ADDR weight2GM,
    GM_ADDR expertIdGM, GM_ADDR scale1GM, GM_ADDR scale2GM,
    GM_ADDR probs, GM_ADDR outGM, GM_ADDR expertTokenNums,
    GM_ADDR workspaceGM, GM_ADDR tilingGM)
...
__aicore__ inline void DispatchFFNCombineBF16<TemplateMMA2ACFunc>::Process()
{
    ...
    using MatmulKernel = Gemm::Kernel::DispatchFFNCombineBF16KernelA2<
        BlockMmad, BlockScheduler, ElementGroupList,
    ...
    typename MatmulKernel::Params params{
        problemShape, static_cast<uint32_t>(EP),
